...
class Prediksi_Akomodasi extends CI_Controller
{
    public function index()
    {
        $kd_hlm = 'SFC1';
        //prediksi perkategori perbulan dalam 1 tahun
        $this->load->view('prediksi/dashboard/akomodasi/beranda', array('kd_hlm' => $kd_hlm));
    }
    ...
    public function menurut_blok1()
    {
        ...
        $this->load->view(
            'prediksi/dashboard/akomodasi/menurut_kategori',
            array(
    ...
    public function cari_blok1()
    {
        ...
        if ($id_pintu != 0 && $tahun != 0) {
            $this->load->view(
                'prediksi/dashboard/akomodasi/beranda_kategori',
    ...
    public function menurut_blok2()
    {
        ...
        $this->load->view(
            'prediksi/dashboard/akomodasi/menurut_wilayah',
            array(
                'data' => $data, 'tahun' => $tahun,
    ...
    public function cari_blok2()
    {
        ...
        if ($id_pintu != 0 && $tahun != 0) {
            $this->load->view(
                'prediksi/dashboard/akomodasi/beranda_wilayah',
    ...
    public function menurut_blok3()
    {
        ...
        $this->load->view(
            'prediksi/dashboard/akomodasi/menurut_provinsi',
            array(
                'data' => $data, 'tahun' => $tahun,
                'data_MAPE' => $data_MAPE
            )
    ...
    public function cari_blok3()
    {
        ...
        if ($tahun != 0) {
            $this->load->view(
                'prediksi/dashboard/akomodasi/beranda_provinsi',
