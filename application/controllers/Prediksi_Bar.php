...
class Prediksi_Bar extends CI_Controller
{
    public function index()
    {
        $kd_hlm = 'SFE';
        //prediksi perkategori perbulan dalam 1 tahun
        $this->load->view('prediksi/dashboard/bar/beranda', array('kd_hlm' => $kd_hlm));
    }
    ...
    public function menurut_blok1()
    {
        ...
        $this->load->view(
            'prediksi/dashboard/bar/menurut_wilayah',
            array(
    ...
    public function cari_blok1()
    {
        ...
        if ($id_pintu != 0 && $tahun != 0) {
            $this->load->view(
                'prediksi/dashboard/bar/beranda_wilayah',
    ...
    public function menurut_blok2()
    {
        ...
        $this->load->view(
            'prediksi/dashboard/bar/menurut_provinsi',
            array(
                'data' => $data, 'tahun' => $tahun,
                'data_MAPE' => $data_MAPE
            )
    ...
    public function cari_blok2()
    {
        ...
        if ($tahun != 0) {
            $this->load->view(
                'prediksi/dashboard/bar/beranda_provinsi',
