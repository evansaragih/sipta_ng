...
class Prediksi_DES_AkomodasiBintang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('prediksi/de_smoothing/akomodasi_bintang/beranda', array('kd_hlm' => $kd_hlm));
    }
    ...
    public function menurut_blok1()
    {
        ...
        $this->load->view(
            'prediksi/de_smoothing/akomodasi_bintang/menurut_kategori',
            array(
    ...
    public function cari_blok1()
    {
        ...
        if ($id_pintu != 0 && $tahun != 0) {
            $this->load->view('prediksi/de_smoothing/akomodasi_bintang/beranda_kategori', 
            array('kd_hlm' => $kd_hlm, 'id_pintu' => $id_pintu, 'tahun' => $tahun));
        } else {
            redirect('Prediksi_DES_AkomodasiBintang');
        }
    }
    ...
    public function menurut_blok2()
    {
        ...
        $this->load->view(
            'prediksi/de_smoothing/akomodasi_bintang/menurut_wilayah',
            array(
                'data' => $data, 'tahun' =>$tahun,
    ...
    public function cari_blok2()
    {
        ...
        if ($id_pintu != 0 && $tahun != 0) {
            $this->load->view('prediksi/de_smoothing/akomodasi_bintang/beranda_wilayah', 
    ...
    public function menurut_blok3()
    {
        ...
        $this->load->view(
            'prediksi/de_smoothing/akomodasi_bintang/menurut_provinsi',
            array(
                'data' => $data, 'tahun' =>$tahun,
                'data_MAPE' => $data_MAPE
            )
    ...
    public function cari_blok3()
    {
        ...
        $tahun = $this->input->post('tahun');
        if ($tahun != 0) {
            $this->load->view('prediksi/de_smoothing/akomodasi_bintang/beranda_provinsi', 
