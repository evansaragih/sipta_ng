...
class Prediksi_RL_Penumpang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('prediksi/regresi_linear/jumlah_penumpang/beranda', array('kd_hlm' => $kd_hlm));
    }
    ...
    public function menurut_blok1()
    {
        ...
        $this->load->view(
            'prediksi/regresi_linear/jumlah_penumpang/menurut_kategori',
            array(
    ...
    public function cari_blok1()
    {
        ...
        if ($id_pintu != 0 && $tahun != 0) {
            $this->load->view('prediksi/regresi_linear/jumlah_penumpang/beranda_kategori', 
    ...
    public function menurut_blok2()
    {
        ...
        $this->load->view(
            'prediksi/regresi_linear/jumlah_penumpang/menurut_provinsi',
            array(
                'data' => $data, 'tahun' =>$tahun,
                'data_MAPE' => $data_MAPE
            )
    ...
    public function cari_blok2()
    {
        ...
        $tahun = $this->input->post('tahun');
        if ($tahun != 0) {
            $this->load->view('prediksi/regresi_linear/jumlah_penumpang/beranda_provinsi', 
