...
class Prediksi_RL_Restoran extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('prediksi/regresi_linear/restoran/beranda', array('kd_hlm' => $kd_hlm));
    }
    ...
    public function menurut_blok1()
    {
        ...
        $this->load->view(
            'prediksi/regresi_linear/restoran/menurut_wilayah',
            array(
    ...
    public function cari_blok1()
    {
        ...
        if ($id_pintu != 0 && $tahun != 0) {
            $this->load->view(
                'prediksi/regresi_linear/restoran/beranda_wilayah',
    ...
    public function menurut_blok2()
    {
        ...
        $this->load->view(
            'prediksi/regresi_linear/restoran/menurut_provinsi',
            array(
                'data' => $data, 'tahun' => $tahun,
                'data_MAPE' => $data_MAPE
            )
    ...
    public function cari_blok2()
    {
        ...
        if ($tahun != 0) {
            $this->load->view(
                'prediksi/regresi_linear/restoran/beranda_provinsi',
