...
class Prediksi_RL_T_Wisman extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('prediksi/regresi_linear/jumlah_wisman_tahun/beranda', array('kd_hlm' => $kd_hlm));
    }
    ...
    public function menurut_blok1()
    {
        ...
        $this->load->view(
            'prediksi/regresi_linear/jumlah_wisman_tahun/menurut_kategori',
            array(
    ...
    public function cari_blok1()
    {
        ...
        if ($id_grup != 0 && $tahun != 0) {
            $this->load->view('prediksi/regresi_linear/jumlah_wisman_tahun/beranda_kategori', 
            array('kd_hlm' => $kd_hlm, 'id_grup' => $id_grup, 'tahun' => $tahun));
        } else {
            redirect('Prediksi_RL_T_Wisman');
        }
    }
    ...
    public function menurut_blok2()
    {
        ...
        $this->load->view(
            'prediksi/regresi_linear/jumlah_wisman_tahun/menurut_provinsi',
            array(
    ...
    public function cari_blok2()
    {
        ...
        $tahun = $this->input->post('tahun');
        if ($tahun != 0) {
            $this->load->view('prediksi/regresi_linear/jumlah_wisman_tahun/beranda_provinsi', 
