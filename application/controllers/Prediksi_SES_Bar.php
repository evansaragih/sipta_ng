...
class Prediksi_SES_Bar extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('prediksi/se_smoothing/bar/beranda', array('kd_hlm' => $kd_hlm));
    }
    ...
    public function menurut_blok1()
    {
        ...
        $this->load->view(
            'prediksi/se_smoothing/bar/menurut_wilayah',
            array(
    ...
    public function cari_blok1()
    {
        ...
        if ($id_pintu != 0 && $tahun != 0) {
            $this->load->view('prediksi/se_smoothing/bar/beranda_wilayah', 
            array('kd_hlm' => $kd_hlm, 'id_pintu' => $id_pintu, 'tahun' => $tahun));
        } else {
            redirect('Prediksi_SES_Bar');
        }
    }
    ...
    public function menurut_blok2()
    {
        ...
        $this->load->view(
            'prediksi/se_smoothing/bar/menurut_provinsi',
            array(
                'data' => $data, 'tahun' =>$tahun,
                'data_MAPE' => $data_MAPE
            )
    ...
    public function cari_blok2()
    {
        ...
        $tahun = $this->input->post('tahun');
        if ($tahun != 0) {
            $this->load->view('prediksi/se_smoothing/bar/beranda_provinsi', 
