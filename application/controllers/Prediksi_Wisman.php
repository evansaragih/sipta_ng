...
class Prediksi_Wisman extends CI_Controller
{
    public function index()
    {
        $kd_hlm = 'SFB1';
        //prediksi perkategori perbulan dalam 1 tahun
        $this->load->view('prediksi/dashboard/jumlah_wisman/beranda', array('kd_hlm' => $kd_hlm));
    }
    ...
    public function menurut_blok1()
    {
        ...
        $this->load->view(
            'prediksi/dashboard/jumlah_wisman/menurut_kategori',
            array(
    ...
    public function cari_blok1()
    {
        ...
        if ($id_grup != 0 && $tahun != 0) {
            $this->load->view(
                'prediksi/dashboard/jumlah_wisman/beranda_kategori',
    ...
    public function menurut_blok2()
    {
        ...
        $this->load->view(
            'prediksi/dashboard/jumlah_wisman/menurut_provinsi',
            array(
                'data' => $data, 'tahun' => $tahun,
                'data_MAPE' => $data_MAPE
            )
    ...
    public function cari_blok2()
    {
        ...
        if ($tahun != 0) {
            $this->load->view(
                'prediksi/dashboard/jumlah_wisman/beranda_provinsi',
