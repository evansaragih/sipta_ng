...
class Upload_Bar extends CI_Controller
{
  public function __construct()
  {
    parent::__construct();
    $this->load->model('M_upload_bar');
  ...
  function index()
  {
    $this->load->view('bar/tambah_data_excel');
  }

  function fetch()
  {
    $data = $this->M_upload_bar->select();
    $output = '
