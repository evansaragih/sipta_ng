...
class Upload_ObjekWisata extends CI_Controller
{
  public function __construct()
  {
    parent::__construct();
    $this->load->model('M_upload_objek_wisata');
  ...
  function index()
  {
    $this->load->view('objek_wisata/tambah_data_excel');
  }

  function fetch()
  {
    $data = $this->M_upload_objek_wisata->select();
    $output = '
  ...
  function import()
  {
    if (isset($_FILES["file"]["name"])) {
      ...
      $this->M_upload_objek_wisata->insert($data);
