...
class M_sp_restoran extends CI_Model
{
  //header1
  ...
  // blok1 menurut restoran
  public function menurut_restoran($id_kab, $tahun, $id_jenis)
  {
    ...
    AND g.id = a.id_jenis_objek AND g.id = 1
    ');
    return $query->result_array();
  }
  ...
  public function menurut_kabupaten($tahun, $id_jenis)
  {
    ...
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1
    GROUP BY e.id
    ');
    return $query->result_array();
  }
  ...
  public function get_kab_denpasar($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 1');
    return $query->row();
  }
  ...
  public function get_kab_badung($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 2');
    return $query->row();
  }
  ...
  public function get_kab_bangli($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 3');
    return $query->row();
  }
  ...
  public function get_kab_buleleng($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 4');
    return $query->row();
  }
  ...
  public function get_kab_gianyar($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 5');
    return $query->row();
  }
  ...
  public function get_kab_jembrana($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 6');
    return $query->row();
  }
  ...
  public function get_kab_klungkung($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 7');
    return $query->row();
  }
  ...
  public function get_kab_karangasem($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 8');
    return $query->row();
  }
  ...
  public function get_kab_tabanan($tahun, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND c.tahun = "' . $tahun . '" AND g.id = 1 AND e.id = 9');
    return $query->row();
  }
  ...
  public function menurut_waktu($id_kab, $id_jenis)
  {
    ...
    FROM dim_objek a, fact_pengunjung_objek b, dim_waktu c, dim_jenis_wisatawan d, dim_kabupaten e, dim_jenis_objek g
    WHERE a.id = b.id_objek AND b.id_jenis_wisatawan = d.id AND c.id = b.id_waktu AND a.id_kabupaten = e.id AND b.id_jenis_wisatawan = d.id AND g.id = a.id_jenis_objek
    AND d.id = "' . $id_jenis . '" AND g.id = 1 AND e.id = "' . $id_kab . '"
