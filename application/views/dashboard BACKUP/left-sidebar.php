                        ...
                        <?php if (strstr($kd_hlm, "SDC")) { ?>
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <?php } ?>
                                    <?php if ($kd_hlm == 'SDC2') { ?>
                                        <li class="active"><a href="<?= base_url('SP_AkomodasiBintang') ?>"><i class="fa fa-circle-o"></i> Kelas Bintang</a></li>
                                    <?php } else { ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?= base_url('Prediksi_SES_Penumpang') ?>"><i class="fa fa-circle-o"></i> Bulanan</a></li>
                                        <li><a href="<?= base_url('Prediksi_SES_T_Penumpang') ?>"><i class="fa fa-circle-o"></i> Tahunan</a></li>
                                    </ul>
                                </li>
                                <li class="treeview">
                                    <a href="#"><i class="fa fa-circle-o"></i>Wisatawan<br />Mancanegara
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?= base_url('Prediksi_SES_Wisman') ?>"><i class="fa fa-circle-o"></i> Bulanan</a></li>
                                        <li><a href="<?= base_url('Prediksi_SES_T_Wisman') ?>"><i class="fa fa-circle-o"></i> Tahunan</a></li>
                                    </ul>
                                </li>
                                <li class="treeview">
                                    <a href="#"><i class="fa fa-circle-o"></i>Akomodasi
