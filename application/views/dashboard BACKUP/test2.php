...
<body class="hold-transition skin-blue fixed sidebar-mini">
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-navy">
                            <div class="inner">
                                ...
                                <p>Kursi
                                    <p style="font-size: 18pt; font-weight: bold;"><?php echo number_format($box1b->jlh_kursi) ?>
                                        <a style="font-size: 12pt;">
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-navy">
                            <div class="inner">
                                ...
                                <p>Kamar
                                    <p style="font-size: 18pt; font-weight: bold;"><?php echo number_format($box2b->jlh_kamar) ?>
                                        <a style="font-size: 12pt;">
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-navy">
                            <div class="inner">
                                ...
                                <p>Bar
                                    <p style="font-size: 18pt; font-weight: bold;"><?php echo number_format($box3b->jlh_bar) ?>
                                        <a style="font-size: 12pt;">
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-6 connectedSortable">
                            <div class="box box-danger box-solid">
                                ...
                                <div class="box-body">
                                    <div id="map1">
                                        <div id="grafik-wilayah_akomodasi_4" style="min-width: 310px; height: 420px; margin: 0 auto"></div>
                                    </div>
                                    <div id="map2" hidden>
    ...
    <script type="text/javascript">
        ...
        Highcharts.mapChart('grafik-wilayah_akomodasi_5', {
            ...
            title: {
                useHTML: true,
                text: "<b><h4 lang='id' translate='yes'><center>Geomaps <?php echo $kat_akomodasi->kategori ?> Berdasarkan Jumlah Kamar </br> Tahun <?php echo $tahun ?></center></h4></b>"
            },
            legend: {
                enabled: true,
                layout: 'horizontal',
