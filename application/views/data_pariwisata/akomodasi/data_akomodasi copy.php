            ...
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="width: 30px;">Pimpinan/GM</th>
                        <th style="width: 30px;">Owner</br>atau Perusahaan</th>
                ...
                <tbody>
                    ...
                    <?php foreach ($data_akomodasi as $dp) {
                        $row_id = $dp['id_akomodasi']; ?>
                        <tr id='tr_<?= $row_id ?>'><?php $no++ ?>
                            <td align='center'><input type="checkbox" class='checkbox' name='delete' value='<?= $row_id ?>'></td>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $dp['nama_hotel']; ?></td>
                            <td><?php echo '<b>'.$dp['kategori'] .'</b></br> Kelas: '.$dp['kelas_bintang'];  ?></td>
                            <td><?php echo $dp['nama_pimpinan'] ?></td>
                            <td><?php echo $dp['nama_perusahaan'] ?></td>
                            ...
                            <td>
                                <center>
                                    <form action="#" method="POST">
                                        <input type="text" id="id_ako-hidden<?= $row_id ?>" name="id_ako-hidden" value="<?php echo $dp['id_akomodasi']; ?>" hidden>
                                        ...
                                        <input type="text" id="akomodasi-hidden<?= $row_id ?>" name="akomodasi-hidden" value="<?php echo $dp['nama_hotel']; ?>" hidden>
                                        <input type="text" id="kat_akomodasi-hidden<?= $row_id ?>" name="kat_akomodasi-hidden" value="<?php echo $dp['kategori']; ?>" hidden>
                                        <input type="text" id="id_kat_akomodasi-hidden<?= $row_id ?>" name="id_kat_akomodasi-hidden" value="<?php echo $dp['id_kategori']; ?>" hidden>
                                        <input type="text" id="kelas_bintang-hidden<?= $row_id ?>" name="kelas_bintang-hidden" value="<?php echo $dp['kelas_bintang']; ?>" hidden>
                                        <input type="text" id="nama_pimpinan-hidden<?= $row_id ?>" name="nama_pimpinan-hidden" value="<?php echo $dp['nama_pimpinan']; ?>" hidden>
                                        <input type="text" id="tahun-hidden<?= $row_id ?>" name="tahun-hidden" value="<?php echo $dp['tahun']; ?>" hidden>
                                        <input type="text" id="telp-hidden<?= $row_id ?>" name="telp-hidden" value="<?php echo $dp['telp']; ?>" hidden>
                                        <input type="text" id="email-hidden<?= $row_id ?>" name="email-hidden" value="<?php echo $dp['email']; ?>" hidden>
                                        <input type="text" id="website-hidden<?= $row_id ?>" name="website-hidden" value="<?php echo $dp['website']; ?>" hidden>
                                        <input type="text" id="alamat-hidden<?= $row_id ?>" name="alamat-hidden" value="<?php echo $dp['alamat']; ?>" hidden>
                                        <input type="text" id="nama_perusahaan-hidden<?= $row_id ?>" name="nama_perusahaan-hidden" value="<?php echo $dp['nama_perusahaan']; ?>" hidden>
                                        <input type="text" id="fax-hidden<?= $row_id ?>" name="fax-hidden" value="<?php echo $dp['fax']; ?>" hidden>
                                        <input type="text" id="jlh_kamar-hidden<?= $row_id ?>" name="jlh_kamar-hidden" value="<?php echo $dp['jumlah_kamar']; ?>" hidden>
                                        ...
                                        <button type="button" id="<?= $row_id ?>" name="update" onclick="detail()" data-role="update" data-id="<?php echo $dp['id_akomodasi']; ?>" class="update btn bg-grey btn-flat">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th style="width: 30px;">Akomodasi</th>
                        <th style="width: 30px;">Kategori</th>
                        <th style="width: 30px;">Nama Pimpinan</th>
                        <th style="width: 30px;">Alamat</th>
                        <th style="width: 30px;">Jumlah Kamar</th>
                        <th style="width: 30px;">Tahun</th>
                        <th style="width: 30px;">Action</th>
