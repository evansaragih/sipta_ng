            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="small-box bg-green">
                        ...
                        <a href="<?php echo base_url('AkomodasiNG') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- /.col-md-3 -->
                <div class="col-md-3">
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            <h4>Petunjuk Upload Data Akomodasi</h4>
...
<div class="box box-solid bg-green-gradient">
    <div class="box-header">
        ...
        <h3 class="box-title">Format File Upload Data Akomodasi Tahun <?= date("Y") ?> </h3>
    </div>
    <!-- /.box-body -->
        ...
        <table id="tbl_format_file" class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width: 30px;">Nama Akomodasi</th>
                    <th style="width: 30px;">Tahun</th>
                    <th style="width: 30px;">Hotel Bintang 1-5/Hotel Melati/Pondok Wisata</th>
...
<script>
    $(document).ready(function() {
        var table = $('#tbl_format_file').DataTable({
            'buttons': [{
                    extend: 'excelHtml5',
                    title: 'Data Jumlah Akomodasi Tahun <?= date("Y") ?> - SIPTA'
                }
                // {
                //     extend: 'print',
...
<script>
    $(document).ready(function() {
        ...
        function load_data() {
            $.ajax({
                url: "<?php echo base_url(); ?>Upload_Akomodasi/fetch",
                method: "POST",
        ...
        $('#import_form').on('submit', function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>Upload_Akomodasi/import",
                method: "POST",
