...
<body class="hold-transition skin-blue fixed sidebar-mini">
    <!-- Site wrapper -->
    <?php $this->load->view('data_pariwisata/bar/alert'); ?>
    <div class="wrapper">
        <!-- =============================================== -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Bar di Bali
                    <small>Berdasarkan Nama Bar dan Kabupaten</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                ...
                <div id="kolom-edit_data" hidden="">
                    <div class="box box-danger">
                        <form class="form-valide" method="post" action="<?php echo base_url('Bar/updateData') ?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="id_bar-edit" name="id_bar-edit" hidden>
                                                <input class="form-control" type="text" id="nama_bar-edit" name="nama_bar-edit">
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Data Jumlah Bar Dihapus ?</h4>
                    </div>
                    <div class="modal-body">
                        <img src="<?php echo base_url('assets/dist/img/disparda.png') ?>" alt="Third slide" width="100%">
                    </div>
                    <div class="modal-footer">
                        <form class="form-valide" method="POST" action="<?php echo base_url('Bar/deleteData2') ?>">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="<?php echo base_url('assets/dist/img/panduan/panduan_bar_1.png') ?>" alt="First slide">
                                </div>
                                <div class="item">
                                    <img src="<?php echo base_url('assets/dist/img/panduan/panduan_perhatian_1.png') ?>" alt="Second slide">
                                </div>
                                <div class="item">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            document.getElementById("nama_bar-edit").disabled = true;
        ...
        function tambah() {
            $("#kolom-data").slideToggle();
            $("#kolom-tambah_data").load("<?php echo site_url(); ?>Bar/col_tambahData");
        ...
        function upload() {
            $("#kolom-tambah_data").fadeOut();
            $("#kolom-tambah_data_excel").load("<?php echo site_url(); ?>Bar/col_tambahDataExcel");
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.update', function() {
            ...
            console.log(row_id);
            var id_bar = $('#id_bar-hidden' + row_id + '').val();
            var kabupaten = $('#kab-hidden' + row_id + '').val();
            var nama_bar = $('#nama_bar-hidden' + row_id + '').val();
