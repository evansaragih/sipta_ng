                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control select2" id="pintu_masuk-add" name="pintu_masuk-add" style="width: 100%;" data-placeholder="Pilih Salah Satu">
                                <option value="" selected>Pilih Salah Satu</option>
                                <?php foreach ($pintu_masuk as $a) { ?>
                                    <option value="<?php echo $a['pintu_masuk']; ?>"><?php echo $a['pintu_masuk']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <!-- /.input group -->
                    ...
                    <div class="perhitungan">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control select2" id="jenis_penumpang-add" name="jenis_penumpang-add" style="width: 100%;" data-placeholder="Pilih Salah Satu">
                                    <option value="" selected>Pilih Salah Satu</option>
                                    <?php foreach ($jenis_penumpang as $a) { ?>
                                        <option value="<?php echo $a['jenis_penumpang']; ?>"><?php echo $a['jenis_penumpang']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <!-- /.input group -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="jumlah_penumpang-add" name="jumlah_penumpang-add" placeholder="Jumlah Penumpang">
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control select2" id="bulan-add" name="bulan-add" style="width: 100%;" data-placeholder="Pilih Salah Satu">
