            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="small-box bg-green">
                        ...
                        <a href="<?php echo base_url('JumlahPenumpang') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- /.col-md-3 -->
                <div class="col-md-3">
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            <h4>Petunjuk Upload Data Penumpang</h4>
                            <p>dapat dilihat disini</p>
                        </div>
                        <div class="icon">
...
<div class="box box-solid bg-green-gradient">
    <div class="box-header">
        ...
        <h3 class="box-title">Format File Upload Data Penumpang Tahun <?= date("Y") ?> </h3>
    </div>
    <!-- /.box-body -->
    <div class="box-footer text-black ekspor_format_file">
        ...
        <table id="tbl_format_file" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th style="width: 10px;">Pintu Masuk</th>
                    <th style="width: 30px;">Bulan</th>
                    <th style="width: 30px;">Tahun</th>
                    <th style="width: 30px;">Penumpang Domestik/Internasional</th>
            ...
            <tbody>
                ...
                <?php foreach ($format_excel as $dp) { ?>
                    <tr>
                        ...
                        <td><?php echo $dp['jenis_penumpang']; ?></td>
                        <td>0</td>
                    </tr>
                <?php } ?>
            </tbody>
...
<script>
    $(document).ready(function() {
        var table = $('#tbl_format_file').DataTable({
            'buttons': [{
                    extend: 'excelHtml5',
                    title: 'Data Jumlah Penumpang Tahun <?= date("Y") ?> - SIPTA'
                }
                // {
                //     extend: 'print',
...
<script type="text/javascript" language="javascript">
    function checkfile(sender) {
        ...
        if (validExts.indexOf(fileExt) < 0) {
            ...
            document.getElementById("import_ako").setAttribute("disabled", "true");
            sweetAlert("Oops...", "File too Big, please select a file less than 4mb", "error");
            $('#file').val('');
...
<script>
    $(document).ready(function() {
        ...
        function load_data() {
            $.ajax({
                url: "<?php echo base_url(); ?>Upload_JumlahPenumpang/fetch",
                method: "POST",
        ...
        $('#import_form').on('submit', function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>Upload_JumlahPenumpang/import",
                method: "POST",
