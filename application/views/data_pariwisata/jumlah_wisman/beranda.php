...
<body class="hold-transition skin-blue fixed sidebar-mini">
    <!-- Site wrapper -->
    <?php $this->load->view('data_pariwisata/jumlah_wisman/alert'); ?>
    <div class="wrapper">
        <!-- =============================================== -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Jumlah Wisatawan Mancanegara ke Bali
                    <small>Berdasarkan Kebangsaan</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a href="#">Data Pariwisata</a></li>
                    <li class="active">Wisatawan Mancanegara</li>
                </ol>
            </section>
            ...
            <section class="content">
                ...
                <div id="kolom-edit_data" hidden="">
                    <div class="box box-danger">
                        <form class="form-valide" method="post" action="<?php echo base_url("JumlahWisman/updateData") ?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="jenis_kebangsaan-edit" name="jenis_kebangsaan-edit" disabled>
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="kebangsaan-edit" name="kebangsaan-edit" disabled>
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="jumlah-edit" name="jumlah-edit" required>
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="id_jlh_wisman-edit" name="id_jlh_wisman-edit" hidden>
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="<?php echo base_url('assets/dist/img/panduan/panduan_wisman_1.png') ?>" alt="First slide">
                                </div>
                                <div class="item">
                                    <img src="<?php echo base_url('assets/dist/img/panduan/panduan_wisman_2.png') ?>" alt="Second slide">
                                </div>
                                <div class="item">
                                    <img src="<?php echo base_url('assets/dist/img/panduan/panduan_perhatian_1.png') ?>" alt="Third slide">
                                </div>
                                <div class="item">
                                    <img src="<?php echo base_url('assets/dist/img/panduan/panduan_perhatian_2.png') ?>" alt="Forth slide">
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function tambah() {
            $("#kolom-data").slideToggle();
            $("#kolom-tambah_data").load("<?php echo site_url(); ?>JumlahWisman/col_tambahData");
        ...
        function upload() {
            $("#kolom-tambah_data").fadeOut();
            $("#kolom-tambah_data_excel").load("<?php echo site_url(); ?>JumlahWisman/col_tambahDataExcel");
            myVar = setTimeout(showPage, 2000);
            $('#kolom-tambah_data_excel').fadeIn(800);
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.update', function() {
            ...
            var id_jlh_wisman = $('#id_jlh_wisman-hidden' + row_id + '').val();
            var tahun = $('#tahun-hidden' + row_id + '').val();
            var bulan = $('#bulan-hidden' + row_id + '').val();
            var jumlah = $('#jumlah-hidden' + row_id + '').val();
            var jenis_kebangsaan = $('#jenis_kebangsaan-hidden' + row_id + '').val();
            console.log(kebangsaan);
            console.log(id_jlh_wisman);
            console.log(bulan);
            console.log(tahun);
            console.log(jumlah);
            console.log(jenis_kebangsaan);
            $('#kebangsaan-edit').val(kebangsaan);
            $('#jenis_kebangsaan-edit').val(jenis_kebangsaan);
            $('#id_jlh_wisman-edit').val(id_jlh_wisman);
