            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            <h4>Petunjuk Upload Data Wisatawan Mancanegara</h4>
...
<div class="box box-solid bg-green-gradient">
    <div class="box-header">
        ...
        <h3 class="box-title">Format File Upload Data Wisatawan Mancanegara Tahun <?= date("Y") ?> </h3>
    </div>
    <!-- /.box-body -->
    <div class="box-footer text-black ekspor_format_file">
        ...
        <table id="tbl_format_file" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th style="width: 10px;">Grup</th>
                    <th style="width: 10px;">Kebangsaan</th>
...
<script>
    $(document).ready(function() {
        var table = $('#tbl_format_file').DataTable({
            'buttons': [{
                    extend: 'excelHtml5',
                    title: 'Data Jumlah Wisatawan Mancanegara Tahun <?= date("Y") ?> - SIPTA'
                }
                // {
                //     extend: 'print',
...
<script>
    $(document).ready(function() {
        ...
        function load_data() {
            $.ajax({
                url: "<?php echo base_url(); ?>Upload_JumlahWisman/fetch",
                method: "POST",
        ...
        $('#import_form').on('submit', function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>Upload_JumlahWisman/import",
                method: "POST",
