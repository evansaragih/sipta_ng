...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Objek Wisata di Bali
                    <small>Berdasarkan Nama Objek Wisata dan Kabupaten</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                ...
                <div id="kolom-edit_data" hidden="">
                    <div class="box box-danger">
                        <form class="form-valide" method="post" action="<?php echo base_url('ObjekWisata/updateData') ?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="id_objek_wisata-edit" name="id_objek_wisata-edit" hidden>
                                                <input class="form-control" type="text" id="nama_objek_wisata-edit" name="nama_objek_wisata-edit">
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Data Objek Wisata Dihapus ?</h4>
                    </div>
                    <div class="modal-body">
                        <img src="<?php echo base_url('assets/dist/img/disparda.png') ?>" alt="Third slide" width="100%">
                    </div>
                    <div class="modal-footer">
                        <form class="form-valide" method="POST" action="<?php echo base_url('ObjekWisata/deleteData2') ?>">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            document.getElementById("nama_objek_wisata-edit").disabled = true;
        ...
        function tambah() {
            $("#kolom-data").slideToggle();
            $("#kolom-tambah_data").load("<?php echo site_url(); ?>ObjekWisata/col_tambahData");
        ...
        function upload() {
            $("#kolom-tambah_data").fadeOut();
            $("#kolom-tambah_data_excel").load("<?php echo site_url(); ?>ObjekWisata/col_tambahDataExcel");
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.update', function() {
            ...
            console.log(row_id);
            var id_objek_wisata = $('#id_objek_wisata-hidden' + row_id + '').val();
            var kabupaten = $('#kab-hidden' + row_id + '').val();
            var nama_objek_wisata = $('#nama_objek_wisata-hidden' + row_id + '').val();
            ...
            console.log(id_objek_wisata);
            console.log(kabupaten);
            console.log(nama_objek_wisata);
            console.log(tahun);
            console.log(alamat);
            console.log(beroperasi_mulai);
            console.log(jenis_wisatawan);
            console.log(jlh_pengunjung);
            $('#id_objek_wisata-edit').val(id_objek_wisata);
            $('#kabupaten-edit').val(kabupaten);
            $('#nama_objek_wisata-edit').val(nama_objek_wisata);
