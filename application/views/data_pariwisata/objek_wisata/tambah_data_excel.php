            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            <h4>Petunjuk Upload Data Objek Wisata</h4>
...
<div class="box box-solid bg-green-gradient">
    <div class="box-header">
        ...
        <h3 class="box-title">Format File Upload Data Objek Wisata Tahun <?= date("Y") ?> </h3>
    </div>
    <!-- /.box-body -->
        ...
        <table id="tbl_format_file" class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width: 30px;">Nama Objek Wisata</th>
...
<script>
    $(document).ready(function() {
        var table = $('#tbl_format_file').DataTable({
            'buttons': [{
                    extend: 'excelHtml5',
                    title: 'Data Objek Wisata Tahun <?= date("Y") ?> - SIPTA'
                }
                // {
                //     extend: 'print',
...
<script>
    $(document).ready(function() {
        ...
        function load_data() {
            $.ajax({
                url: "<?php echo base_url(); ?>Upload_ObjekWisata/fetch",
                method: "POST",
        ...
        $('#import_form').on('submit', function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>Upload_ObjekWisata/import",
                method: "POST",
