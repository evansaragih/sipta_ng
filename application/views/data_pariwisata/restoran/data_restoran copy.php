            ...
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="width: 30px;">Jumlah Kursi</th>
                        <th style="width: 30px;">Keterangan</th>
                        <th style="width: 30px;">Dibuat Oleh</th>
                ...
                <tbody>
                    ...
                    <?php foreach ($data_akomodasi as $dp) {
                        $row_id = $dp['id_restoran']; ?>
                        <tr id='tr_<?= $row_id ?>'><?php $no++ ?>
                            <td align='center'><input type="checkbox" class='checkbox' name='delete' value='<?= $row_id ?>'></td>
                            <td><?php echo $no; ?></td>
                            <td data-target="akomodasi"><?php echo $dp['nama_restoran']; ?></td>
                            <td data-target="kabupaten"><?php echo $dp['kabupaten']; ?></td>
                            <td data-target="bulan"><?php echo $dp['tahun']; ?></td>
                            <td data-target="jlh_kursi"><?php echo $dp['jumlah_kursi']; ?></td>
                            <td data-target="keterangan"><?php echo $dp['keterangan']; ?></td>
                            <td data-target="total" style="font-size: 9pt;"><?php echo $dp['created_by']; ?> pada <a style="font-size: 9pt;"><?php echo $dp['created_at']; ?></a> </br>:: diupdate pada <a style="font-size: 9pt;"><?php echo $dp['updated_at']; ?></a> </td>
                            <td>
                                <center>
                                    <form action="#" method="POST">
                                        <input type="text" id="id_ako-hidden<?= $row_id ?>" name="id_ako-hidden" value="<?php echo $dp['id_restoran']; ?>" hidden>
                                        ...
                                        <input type="text" id="nama_hotel-hidden<?= $row_id ?>" name="nama_hotel-hidden" value="<?php echo $dp['nama_restoran']; ?>" hidden>
                                        <input type="text" id="jlh_kamar-hidden<?= $row_id ?>" name="jlh_kamar-hidden" value="<?php echo $dp['jumlah_kursi']; ?>" hidden>
