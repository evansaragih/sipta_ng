<div class="box box-danger">
    <form class="form-valide" method="post" action="<?php echo base_url('Restoran/insertData') ?>">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" id="akomodasi-add" name="akomodasi-add" placeholder="nama restoran">
                        </div>
                        <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="jlh_room-add" name="jlh_room-add" placeholder="jumlah tempat duduk">
                        </div>
                        <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
