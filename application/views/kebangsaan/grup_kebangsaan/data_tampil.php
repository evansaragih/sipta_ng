...
<div class="box">
    <div class="box-header">
        <table border="0">
            <tr>
                <td class="col-xs-6">
                    <h3 class="box-title" style="margin-left: -10px;">Data Kategori Kebangsaan Menurut Nama Kebangsaan</h3>
                </td>
                <td class="col-xs-2">
                ...
                <tbody>
                    ...
                    <?php foreach ($data_akomodasi as $dp) {
                        ...
                        <tr id='tr_<?= $row_id ?>'><?php $no++ ?>
                            ...
                            <td><?php echo $no; ?></td>
                            <td data-target="akomodasi"><?php echo $dp['grup']; ?></td>
                            <td>
                                <center>
                                    <form action="#" method="POST">
                                        <input type="text" id="id_grup-hidden<?= $row_id ?>" name="id_grup-hidden" value="<?php echo $dp['id']; ?>" hidden>
                                        <input type="text" id="grup-hidden<?= $row_id ?>" name="grup-hidden" value="<?php echo $dp['grup']; ?>" hidden>
                                        <input type="text" id="path_map-hidden<?= $row_id ?>" name="path_map-hidden" value="<?php echo $dp['path_map']; ?>" hidden>
