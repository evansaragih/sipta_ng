        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?= base_url('Akomodasi') ?>"><i class="fa fa-circle-o"></i> Akomodasi</a></li>
                    ...
                    <li class="active"><a href="<?= base_url('Pramuwisata') ?>"><i class="fa fa-circle-o"></i> Pramuwisata</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
