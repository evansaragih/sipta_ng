...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_Akomodasi/cari_blok1") ?>">
                        <div class="col-md-4">
                            <select class="form-control select2" id="id_pintu" name="id_pintu" style="width: 100%;" data-placeholder="Pilih Salah Satu" onchange="form.submit()">
                                <?php foreach ($pintu_masuk as $a) { ?>
                                    <option value="<?php echo $a['id']; ?>" <?= $id_pintu == $a['id'] ? "selected" : null  ?>><?php echo $a['kategori']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-2">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_3a" data-toggle="tab">Tamu</a></li>
        ...
        <div class="tab-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseBlok1A">
                                        Grafik Garis Prediksi
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseBlok1A" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_unit" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseBlok1A" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_unit_b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel box box-danger">
                            ...
                            <div class="panel-collapse collapse in">
                                <div class="box-body blok1A">
                                    <!-- ini tabel -->
                                    <table class="table table-bordered table-striped" id="blok1A" style="text-align: right">
                                        <thead>
                                            <tr>
            ...
            <table id="data_prediksi_akomodasi_unit" border="1" hidden>
                <thead>
                    <tr>
                        <th>Waktu</th>
                        <th>Prediksi Regresi Linear</th>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseBlok1B">
                                        Grafik Garis Prediksi
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseBlok1B" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_kamar" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseBlok1B" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_kamar_b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Tabel grafik prediksi -->
            <table id="data_prediksi_akomodasi_kamar" border="1" hidden>
                <thead>
                    <tr>
                        <th>Waktu</th>
                        <th>Prediksi Regresi Linear</th>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseBlok1B" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_tamu" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseBlok1B" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_tamu_b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Tabel grafik prediksi -->
            <table id="data_prediksi_akomodasi_tamu" border="1" hidden>
                <thead>
                    <tr>
                        <th>Waktu</th>
                        <th>Prediksi Regresi Linear</th>
...
<script>
    $(document).ready(function() {
        var table = $('#blok1A').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di Bali <?php $tahun_data = $tahun - 1 ?> Sampai Tahun <?php echo $tahun_data; ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di Bali <?php $tahun_data = $tahun - 1 ?> Sampai Tahun <?php echo $tahun_data; ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di Bali <?php $tahun_data = $tahun - 1 ?> Sampai Tahun <?php echo $tahun_data; ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit', {
        data: {
            table: 'data_prediksi_akomodasi_unit'
        },
        chart: {
            type: 'line'
        },
        title: {
            useHTML: true,
            text: "<h4>Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_b', {
        data: {
            table: 'data_prediksi_akomodasi_unit'
        },
        chart: {
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_kamar', {
        data: {
            table: 'data_prediksi_akomodasi_kamar'
        },
        chart: {
            type: 'line'
        },
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_kamar_b', {
        data: {
            table: 'data_prediksi_akomodasi_kamar'
        },
        chart: {
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_tamu', {
        data: {
            table: 'data_prediksi_akomodasi_tamu'
        },
        chart: {
            type: 'line'
        },
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_tamu_b', {
        data: {
            table: 'data_prediksi_akomodasi_tamu'
        },
        chart: {
