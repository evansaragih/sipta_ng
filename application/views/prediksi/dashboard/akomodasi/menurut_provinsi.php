...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_Akomodasi/cari_blok3") ?>">
                        <div class="col-md-2">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1c" data-toggle="tab">Unit</a></li>
            <li><a href="#tab_2c" data-toggle="tab">Kamar</a></li>
            <li><a href="#tab_3c" data-toggle="tab">Tamu</a></li>
            <li class="pull-right"><a href="#" class="text-muted"><i class="fa fa-line-chart"></i></a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1c">
                <!-- RL -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseBlok3A">
                                        Grafik Garis Prediksi
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseBlok3A" class="panel-collapse collapse in">
                                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseBlok3B">
                                        Grafik Batang Prediksi
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseBlok3B" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_unit_3b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table id="data_prediksi_akomodasi_unit_3" border="1" hidden>
                <thead>
                    <tr>
                        <th>Waktu</th>
                        <th>Prediksi Regresi Linear</th>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseBlok3B" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_kamar_3b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Tabel grafik prediksi -->
            <table id="data_prediksi_akomodasi_kamar_3" border="1" hidden>
                <thead>
                    <tr>
                        <th>Waktu</th>
                        <th>Prediksi Regresi Linear</th>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseBlok3A" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_tamu_3" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseBlok3C">
                                        Grafik Batang Prediksi
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseBlok3C" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_tamu_3b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Tabel grafik prediksi -->
            <table id="data_prediksi_akomodasi_tamu_3" border="1" hidden>
                <thead>
                    <tr>
                        <th>Waktu</th>
                        <th>Prediksi Regresi Linear</th>
...
<script>
    $(document).ready(function() {
        var table = $('#blok3A').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Prediksi Akomodasi di Bali <?php $tahun_data = $tahun + 4;
                ...
                {
                    extend: 'print',
                    title: '<h4>Prediksi Akomodasi di Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_3', {
        data: {
            table: 'data_prediksi_akomodasi_unit_3'
        },
        chart: {
            type: 'line'
        },
        title: {
            useHTML: true,
            text: "<h4>Akomodasi di Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_3b', {
        data: {
            table: 'data_prediksi_akomodasi_unit_3'
        },
        chart: {
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_kamar_3', {
        data: {
            table: 'data_prediksi_akomodasi_kamar_3'
        },
        chart: {
            type: 'line'
        },
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_kamar_3b', {
        data: {
            table: 'data_prediksi_akomodasi_kamar_3'
        },
        chart: {
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_tamu_3', {
        data: {
            table: 'data_prediksi_akomodasi_tamu_3'
        },
        chart: {
            type: 'line'
        },
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_tamu_3b', {
        data: {
            table: 'data_prediksi_akomodasi_tamu_3'
        },
        chart: {
