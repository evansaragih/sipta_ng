...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_Akomodasi/cari_blok2") ?>">
                        <div class="col-md-3">
                            <select class="form-control select2" id="id_kabupaten" name="id_kabupaten" style="width: 100%;" data-placeholder="Pilih Salah Satu" onchange="form.submit()">
                                ...
                                <?php foreach ($kabupaten as $a) { ?>
                                    <option value="<?php echo $a['id']; ?>" <?= $kab == $a['id'] ? "selected" : null  ?>><?php echo $a['kabupaten']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-4">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_3b" data-toggle="tab">Tamu</a></li>
        ...
        <div class="tab-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseBlok3B" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_tamu_2" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseBlok3B" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <div id="prediksi_akomodasi_tamu_2b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Tabel grafik prediksi -->
            <table id="data_prediksi_akomodasi_tamu_2" border="1" hidden>
                <thead>
                    <tr>
                        <th>Waktu</th>
                        <th>Prediksi Regresi Linear</th>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#blok2A').DataTable({
                'buttons': [{
                        extend: 'csvHtml5',
                        title: 'Prediksi Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
                    ...
                    {
                        extend: 'print',
                        title: '<h4>Prediksi Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_unit_2', {
            ...
            title: {
                useHTML: true,
                text: "<h4>Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_tamu_2', {
            data: {
                table: 'data_prediksi_akomodasi_tamu_2'
            },
            chart: {
                type: 'line'
            },
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_tamu_2b', {
            data: {
                table: 'data_prediksi_akomodasi_tamu_2'
            },
            chart: {
