    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_AkomodasiBintang/cari_blok1") ?>">
                        <div class="col-md-4">
                            <select class="form-control select2" id="id_pintu" name="id_pintu" style="width: 100%;" data-placeholder="Pilih Salah Satu" onchange="form.submit()">
                                <option value="1" <?= $id_pintu == 1 ? "selected" : null  ?>>Hotel Bintang 1</option>
                                <option value="2" <?= $id_pintu == 2 ? "selected" : null  ?>>Hotel Bintang 2</option>
                                <option value="3" <?= $id_pintu == 3 ? "selected" : null  ?>>Hotel Bintang 3</option>
                                <option value="4" <?= $id_pintu == 4 ? "selected" : null  ?>>Hotel Bintang 4</option>
                                <option value="5" <?= $id_pintu == 5 ? "selected" : null  ?>>Hotel Bintang 5</option>
                            </select>
                        </div>
                        <div class="col-md-2">
...
<script>
    $(document).ready(function() {
        var table = $('#blok1A').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di Bali <?php $tahun_data = $tahun + 4;
                ...
                {
                    extend: 'print',
                    title: '<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di Bali <?php $tahun_data = $tahun + 4;
