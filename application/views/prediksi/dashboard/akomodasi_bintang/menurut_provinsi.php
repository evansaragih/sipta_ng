    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_AkomodasiBintang/cari_blok3") ?>">
                        <div class="col-md-2">
                        ...
                        <div class="panel box box-danger">
                            ...
                            <div class="panel-collapse collapse in">
                                <div class="box-body blok3A">
                                    <!-- ini tabel -->
                                    <table class="table table-bordered table-striped" id="blok3A" style="text-align: right">
                                        <thead>
                                            <tr>
...
<script>
    $(document).ready(function() {
        var table = $('#blok3A').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Akomodasi di Bali <?php $tahun_data = $tahun + 4;
                ...
                {
                    extend: 'print',
                    title: '<h4>Akomodasi di Bali <?php $tahun_data = $tahun + 4;
