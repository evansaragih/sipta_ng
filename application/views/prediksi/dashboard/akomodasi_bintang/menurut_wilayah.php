...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_AkomodasiBintang/cari_blok2") ?>">
                        <div class="col-md-3">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#blok2A').DataTable({
                'buttons': [{
                        extend: 'csvHtml5',
                        title: 'Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
                    ...
                    {
                        extend: 'print',
                        title: '<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_unit_2', {
            ...
            title: {
                useHTML: true,
                text: "<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
