...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_Bar/cari_blok1") ?>">
                        <div class="col-md-3">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#blok2A').DataTable({
                'buttons': [{
                        extend: 'csvHtml5',
                        title: 'Prediksi Kunjungan Bar di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
        ...
        $(document).ready(function() {
            var table = $('#blok2B').DataTable({
                'buttons': [{
                    ...
                    {
                        extend: 'print',
                        title: '<h4>Prediksi Kunjungan Bar di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_unit_2', {
            ...
            title: {
                useHTML: true,
                text: "<h4>Prediksi Bar di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_kamar_2', {
            ...
            title: {
                useHTML: true,
                text: "<h4>Prediksi Kunjungan Bar di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
                                                                                        echo " Tahun " . $tahun . " - Tahun " . $tahun_data; ?></h4>"
            },
            yAxis: {
                allowDecimals: false,
