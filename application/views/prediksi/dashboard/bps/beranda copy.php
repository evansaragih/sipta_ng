...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Prediksi (Forecasting)
                    <small>Restoran di Provinsi Bali</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                ...
                <?php $html = file_get_contents("http://bnpb.cloud/dibi/tabel3b");
                echo $html; ?>
                <table class="table table-bordered table-striped" style="text-align: right" hidden>
                    <?php
                    ...
                    $sumber =  resourceWeb('http://bnpb.cloud/dibi//tabel3b');
                    $split = explode('<table id="tbl" class="table table-bordered table-striped table-condensed table-hover cell-border">', $sumber);
                    $splitLagi = explode('</table>', $split[1]);

                    // $sumber =  resourceWeb('https://bali.bps.go.id/dynamictable/2016/11/23/62/kedatangan-wisatawan-mancanegara-menurut-kawasan-2008-2019.html');
                    // $split = explode('<table class="tabel_hasil" align="center" cellpadding="0" cellspacing="0">', $sumber);
                    // $splitLagi = explode('</table>', $split[0]);

                    echo $splitLagi[0];

                    // URL TARGET
                    // $url = 'http://bnpb.cloud/dibi//tabel3b';
                    // //end
                    // // get / mengambil content berdasarkan url yang akan di curi datanya
                    // $content = file_get_contents($url);
                    // //
                    // // STEP 1 mengambil syntax pembuka
                    // $first_step = explode("<table id='tbl' class='table table-bordered table-striped table-condensed table-hover cell-border'>", $content);
                    // //
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_Restoran/menurut_blok1");
        ...
        function menurut_blok2() {
            ...
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>Prediksi_Restoran/menurut_blok2");
