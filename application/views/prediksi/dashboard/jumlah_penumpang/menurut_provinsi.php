    ...
    <div class="kotak-prediksi box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_Penumpang/cari_blok2") ?>">
                        <div class="col-md-2">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseThree" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_penumpang_2" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseThree" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_penumpang_2b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
...
<table id="data_prediksi_penumpang_2" border="1" hidden>
    <thead>
        <tr>
            <th>Waktu</th>
            <th>Prediksi Regresi Linear</th>
...
<script>
    $(document).ready(function() {
        var table = $('#blok2A').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Prediksi Penumpang ke Bali <?php echo " Tahun " . $tahun; ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Prediksi Penumpang ke Bali <?php echo " Tahun " . $tahun; ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Prediksi Penumpang ke Bali <?php echo " Tahun " . $tahun; ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
...
<script type="text/javascript">
    Highcharts.chart('prediksi_penumpang_2', {
        data: {
            table: 'data_prediksi_penumpang_2'
        },
        chart: {
            type: 'line'
        },
        title: {
            useHTML: true,
            text: "<h4>Prediksi Penumpang ke Bali <?php echo " Tahun " . $tahun; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<script type="text/javascript">
    Highcharts.chart('prediksi_penumpang_2b', {
        data: {
            table: 'data_prediksi_penumpang_2'
        },
        chart: {
