    ...
    <div class="kotak-prediksi box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_T_Penumpang/cari_blok2") ?>">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseBlok2A" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_penumpang_tahun_2" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseBlok2A" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_penumpang_tahun_2b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
...
<table id="data_prediksi_penumpang_tahun_2" border="1" hidden>
    <thead>
        <tr>
            <th>Waktu</th>
            <th>Prediksi Regresi Linear</th>
...
<script>
    $(document).ready(function() {
        var table = $('#blok2A').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Prediksi Penumpang ke Bali <?php $tahun_data = $tahun + 4;
                ...
                {
                    extend: 'print',
                    title: '<h4>Prediksi Penumpang ke Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_penumpang_tahun_2', {
        data: {
            table: 'data_prediksi_penumpang_tahun_2'
        },
        chart: {
            type: 'line'
        },
        title: {
            useHTML: true,
            text: "<h4>Prediksi Penumpang ke Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_penumpang_tahun_2b', {
        data: {
            table: 'data_prediksi_penumpang_tahun_2'
        },
        chart: {
