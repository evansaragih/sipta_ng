    ...
    <div class="kotak-prediksi box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_Wisman/cari_blok1") ?>">
                        <div class="col-md-4">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseThree" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_jwisman_b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-bordered table-striped" id="blok1C" style="text-align: right">
                            ...
                            <tbody>
                                ...
                                <?php for (
                                    ...
                                    <tr>
                                        <td style="text-align: left;" hidden><?php echo $rank + $forecast ?></td>
                                        <td><?php echo $tahun ?>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman_b', {
        data: {
            table: 'data_prediksi_wisman'
        },
        chart: {
