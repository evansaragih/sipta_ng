    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_T_Wisman/cari_blok1") ?>">
                        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseBlok1A" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_wisman_tahun" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseBlok1A" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_wisman_tahun_b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
...
<table id="data_prediksi_wisman_tahun" border="1" hidden>
    <thead>
        <tr>
            <th>Waktu</th>
            <th>Prediksi Regresi Linear</th>
...
<script>
    $(document).ready(function() {
        var table = $('#blok1A').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Prediksi Wisatawan Mancanegara <?php echo $data_id_group->grup ?> ke Bali <?php $tahun_data = $tahun + 4;
                ...
                {
                    extend: 'print',
                    title: '<h4>Prediksi Wisatawan Mancanegara <?php echo $data_id_group->grup ?> ke Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_wisman_tahun', {
        data: {
            table: 'data_prediksi_wisman_tahun'
        },
        chart: {
            type: 'line'
        },
        title: {
            useHTML: true,
            text: "<h4>Prediksi Wisatawan Mancanegara <?php echo $data_id_group->grup ?> ke Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_wisman_tahun_b', {
        data: {
            table: 'data_prediksi_wisman_tahun'
        },
        chart: {
