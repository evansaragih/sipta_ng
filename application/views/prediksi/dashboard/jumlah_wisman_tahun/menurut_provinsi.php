    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_T_Wisman/cari_blok2") ?>">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseBlok2A" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_wisman_tahun_2" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel box box-danger">
                ...
                <div id="collapseBlok2A" class="panel-collapse collapse in">
                    <div class="box-body">
                        <div id="prediksi_wisman_tahun_2b" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
...
<table id="data_prediksi_wisman_tahun_2" border="1" hidden>
    <thead>
        <tr>
            <th>Waktu</th>
            <th>Prediksi Regresi Linear</th>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_wisman_tahun_2', {
        data: {
            table: 'data_prediksi_wisman_tahun_2'
        },
        chart: {
            type: 'line'
        },
...
<script type="text/javascript">
    Highcharts.chart('prediksi_wisman_tahun_2b', {
        data: {
            table: 'data_prediksi_wisman_tahun_2'
        },
        chart: {
