...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_ObjekWisata/cari_blok2") ?>">
                        <div class="col-md-2">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_2c" data-toggle="tab">Pengunjung</a></li>
...
<script>
    $(document).ready(function() {
        var table = $('#blok1A').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Prediksi Kunjungan Objek Wisata di Bali <?php $tahun_data = $tahun + 4;
                ...
                {
                    extend: 'print',
                    title: '<h4>Prediksi Kunjungan Objek Wisata di Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_3', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Objek Wisata di Bali <?php $tahun_data = $tahun + 4;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_kamar_3', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Kunjungan Objek Wisata di Bali <?php $tahun_data = $tahun + 4;
                                                                echo " Tahun  " . $tahun . " - Tahun " . $tahun_data; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
