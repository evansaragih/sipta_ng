            ...
            <div class="tab-pane active" id="tab_1a">
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseBlok1A" class="panel-collapse collapse in">
                        <div class="box-body">
                            <div id="prediksi_akomodasi_unit" style="width: 1150px; height: 600px; margin: 0 auto"></div>
                        </div>
                    </div>
                </div>
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $dp) { ?>
                        <tr>
                            ...
                            <td><?php echo $F_after_SES;
                                $A_before_SES = $dp['jumlah_unit'];
                                $F_before_SES = $F_after_SES; ?></td>
                            <!-- ./SE -->
            ...
            <div class="tab-pane" id="tab_2a">
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseBlok1B" class="panel-collapse collapse in">
                        <div class="box-body">
                            <div id="prediksi_akomodasi_kamar" style="width: 1150px; height: 600px; margin: 0 auto"></div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di Bali <?php $tahun_data = $tahun + 4; echo " Tahun " . $tahun. " - Tahun ". $tahun_data; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
