    ...
    <tbody>
        ...
        <?php foreach ($data as $dp) { ?>
            <tr>
                ...
                <td><?php echo $dp['bulan'] . '' . $dp['tahun'] ?></td>
                <td><?php echo ($dp['jumlah']) ?></td>
                <td>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_penumpang', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Penumpang <?php echo $nama_pintu_masuk->pintu_masuk ?> ke Bali <?php $tahun_data = $tahun + 4; echo " Tahun " . $tahun . " - Tahun " . $tahun_data; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
