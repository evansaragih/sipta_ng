...
<body class="hold-transition skin-blue fixed sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Prediksi (Forecasting)
                    <small>Jumlah Wisatawan Mancanegara ke Provinsi Bali</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a href="#">Prediksi (Forecasting)</a></li>
                    <li class="active">Jumlah Wisman</li>
                </ol>
            </section>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_Wisman/menurut_blok1");
        ...
        function menurut_blok1() {
            ...
            $('#logo_loading').fadeIn();
            $('#teks_loading').fadeIn();
            $("#kolom-menurut_blok2").fadeOut(0);
            $("#kolom-menurut_blok3").fadeOut(0);
            $("#kolom-menurut_blok4").fadeOut(0);
            $("#kolom-menurut_blok5").fadeOut(0);
            $('#kolom-menurut_blok1').fadeToggle(5000);
            myVar = setTimeout(showPage, 5000);
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_Wisman/menurut_blok1");
        ...
        function menurut_blok2() {
            ...
            $('#kolom-menurut_blok2').fadeToggle(5000);
            myVar = setTimeout(showPage, 5000);
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>Prediksi_Wisman/menurut_blok2");
            $("#kolom-menurut_blok2").fadeIn(1000);
        }
