                            ...
                            <tbody>
                                ...
                                <?php for (
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            echo number_format(($f + ($e * (($rank + ($forecast + 1)))))); ?>
                                        </td>
                                        <td><?php
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Wisatawan Mancanegara <?php echo $data_id_group->jenis_kebangsaan ?> ke Bali <?php $tahun_data = $tahun + 4; echo " Tahun " . $tahun . " - Tahun " . $tahun_data; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
