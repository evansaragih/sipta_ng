    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_DES_AkomodasiBintang/cari_blok1") ?>">
                        <div class="col-md-4">
...
<script type="text/javascript">
    Highcharts.chart('prediksi_ako_unit', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di Bali <?php echo " Tahun ".$tahun." Sampai Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
