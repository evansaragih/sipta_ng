    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_DES_Bar/cari_blok2") ?>">
                        <div class="col-md-2">
        ...
        <div class="box-header with-border">
            <h4 class="box-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                    <p class="box-title" style="text-align: center; font-size: 13pt;">Jumlah Bar di Bali
...
<table id="data_bar_unit_3" border="1" hidden>
    <thead>
        <tr>
            <th>Tahun</th>
            <th>Data Aktual</th>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman', {
        ...
        title: {
            useHTML : true,
            text: "<h4>Prediksi Bar di Bali <?php echo " Tahun ".$tahun." Sampai Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
