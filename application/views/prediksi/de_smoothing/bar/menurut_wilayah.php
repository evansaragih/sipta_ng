...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_DES_Bar/cari_blok1") ?>">
                        <div class="col-md-3">
        ...
        <div class="box-header with-border">
            <h4 class="box-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                    <p class="box-title" style="text-align: center; font-size: 13pt;">Jumlah Bar di <?php echo $nama_kab->kabupaten?>
    ...
    <div class="panel box box-danger">
        ...
        <div id="collapseTwo" class="panel-collapse collapse in">
            <div class="box-body">
                <div id="prediksi_jbar_2" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
            </div>
...
<table id="data_bar_unit_2" border="1" hidden>
    <thead>
        <tr>
            <th>Tahun</th>
            <th>Data Aktual</th>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jbar_2', {
        data: {
            table: 'data_bar_unit_2'
        },
        chart: {
            type: 'line'
        },
        title: {
            useHTML : true,
            text: "<h4>Prediksi Bar di <?php echo $nama_kab->kabupaten?> <?php echo " Tahun ".$tahun." Sampai Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
