...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo base_url('Prediksi_DES_Penumpang/hasil_cari_blok1/' . $id_pintu . '/' . $tahun); ?>");
        ...
        function menurut_blok1() {
            ...
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_DES_Penumpang/menurut_blok1");
        ...
        function menurut_blok2() {
            ...
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>Prediksi_DES_Penumpang/menurut_blok2");
