...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#kolom-menurut_blok1').fadeIn(3000);
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_DES_Wisman/menurut_blok1", 3000);
        });
        ...
        function menurut_blok1() {
            ...
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_DES_Wisman/menurut_blok1", 5000);
            // $('#konten').fadeIn(100);
        }
        ...
        function menurut_blok2() {
            ...
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>Prediksi_DES_Wisman/menurut_blok2", 5000);
        }
