...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_DES_Wisman/cari_blok2") ?>">
    ...
    <div class="panel box box-danger">
        ...
        <div id="collapseFour" class="panel-collapse collapse in">
            <div class="box-body">
                <div id="prediksi_jwisman_2" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
            </div>
    ...
    <table id="data_prediksi_wisman_2" border="1" hidden>
        <thead>
            <tr>
                <th>Tahun</th>
                <th>Data Aktual</th>
        ...
        <tbody>
            ...
            <?php for (
                ...
                <tr>
                    <td><?php echo $month[$forecast] . '' . $tahun; ?></td>
                    <td></td>
                    <td><?php
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman_2', {
        data: {
            table: 'data_prediksi_wisman_2'
        },
        chart: {
            type: 'line'
        },
        title: {
            useHTML: true,
            text: "<h4>Prediksi Wisatawan Mancanegara ke Bali Tahun <?= $tahun; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
