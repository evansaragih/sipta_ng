    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_DES_ObjekWisata/cari_blok1") ?>">
                        <div class="col-md-3">
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseSeven">
                                <p class="box-title" style="text-align: center; font-size: 13pt;">Jumlah Kunjungan pada Objek Wisata di <?php echo $nama_kab->kabupaten ?>
                                    <?php $tahun_data = $tahun - 1;
                                    echo " Sampai Tahun " . $tahun_data; ?>
                                </p>
                            </a>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_2', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Objek Wisata di <?php echo $nama_kab->kabupaten ?><?php echo " Tahun ".$tahun." Sampai Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_kamar_2', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Kunjungan pada Objek Wisata di <?php echo $nama_kab->kabupaten ?> <?php echo " Tahun ".$tahun." Sampai Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
