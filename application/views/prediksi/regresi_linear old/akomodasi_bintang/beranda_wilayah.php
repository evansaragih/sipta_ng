...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#kolom-menurut_blok2").load("<?php echo base_url('Prediksi_RL_AkomodasiBintang/hasil_cari_blok2/'.$id_pintu.'/'.$tahun.'/'.$kab); ?>");
        ...
        function menurut_blok1() {
            ...
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_RL_AkomodasiBintang/menurut_blok1");
        ...
        function menurut_blok2() {
            ...
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>Prediksi_RL_AkomodasiBintang/menurut_blok2");
        ...
        function menurut_blok3() {
            ...
            $("#kolom-menurut_blok5").fadeOut();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok3").load("<?php echo site_url(); ?>Prediksi_RL_AkomodasiBintang/menurut_blok3");
