...
<div id="konten">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1a">
                <div class="box-body">
                    <div class="box-header with-border">
                        <center>
                            <p class="box-title" style="text-align: center; font-size: 13pt;">Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di Bali
    ...
    <div class="box box-solid" id="grafik-A_blok1">
        ...
        <div class="box-body blok1D">
            <!-- ini tabel -->
            <table class="table table-bordered table-striped" id="blok1D" style="text-align: right">
                <thead>
                    <tr>
                        <th>Periode</th>
                        <th>Tahun</th>
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_2b" data-toggle="tab">Kamar</a></li>
            <li class="pull-right"><a href="#" class="text-muted"><i class="fa fa-line-chart"></i></a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1b">
                <div class="box-body">
                    <div id="prediksi_jwisman" style="min-width: 300px; height: 600px; margin: 0 auto"></div>
                </div>
            </div>
            <!-- /.tab-pane -->
            <div class="tab-pane" id="tab_2b">
                <div class="box-body">
                    <div id="prediksi_akomodasi_kamar" style="min-width: 300px; height: 600px; margin: 0 auto"></div>
                </div>
            </div>
            <!-- /.tab-pane -->
        </div>
...
<table id="data_prediksi_wisman" border="1">
    <thead>
        <tr>
            <th>Tahun</th>
            <th>Tahun Aktual</th>
...
<table id="data_akomodasi_kamar" border="1">
    <thead>
        <tr>
            <th>Tahun</th>
            <th>Tahun Aktual</th>
