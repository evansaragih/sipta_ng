...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_RL_AkomodasiBintang/cari_blok2") ?>">
                        <div class="col-md-3">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_2a_2" data-toggle="tab">Kamar</a></li>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1a_2">
                <div class="box-body">
                    <div class="box-header with-border">
                        <center>
                            <p class="box-title" style="text-align: center; font-size: 13pt;">Akomodasi Hotel Bintang - <?php echo $id_pintu.' di '.$nama_kab->kabupaten ?>
    ...
    <div class="box box-solid" id="grafik-A_blok1">
        ...
        <div class="box-body blok2D">
            <!-- ini tabel -->
            <table class="table table-bordered table-striped" id="blok2D" style="text-align: right">
                <thead>
                    <tr>
                        <th>Periode</th>
                        <th>Tahun</th>
                    ...
                    <?php foreach ($data_MAPE as $dp) { ?>
                        <tr> <?php $rank_grafik++ ?>
                            ...
                            <td>
                                <?php $APE_grafik = 0;
                                if ($dp['jumlah_unit'] != 0) {
                                    $APE_grafik = round(abs((($dp['jumlah_unit']) - $prediksi_grafik) / ($dp['jumlah_unit']) * 100), 2);
                                    echo $APE_grafik;
                                } else {
                                    echo $APE_grafik = 0;
                                }
                            ...
                            <td>
                                <?php $APE_grafik = 0;
                                if ($dp['jumlah_kamar'] != 0) {
                                    $APE_grafik = round(abs((($dp['jumlah_kamar']) - $prediksi_grafik2) / ($dp['jumlah_kamar']) * 100), 2);
                                    echo $APE_grafik;
                                } else {
                                    echo $APE_grafik = 0;
                                }
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1b_2" data-toggle="tab">Unit</a></li>
            <li><a href="#tab_2b_2" data-toggle="tab">Kamar</a></li>
            <li class="pull-right"><a href="#" class="text-muted"><i class="fa fa-line-chart"></i></a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1b_2">
                <div class="box-body">
                    <div id="prediksi_akomodasi_unit_2" style="min-width: 310px; height: 600px; margin: 0 auto"></div>
                </div>
            </div>
            <!-- /.tab-pane -->
            <div class="tab-pane" id="tab_2b_2">
                <div class="box-body">
...
<table id="data_akomodasi_unit_2" border="1">
    <thead>
        <tr>
            <th>Tahun</th>
            <th>Tahun Aktual</th>
...
<table id="data_akomodasi_kamar_2" border="1">
    <thead>
        <tr>
            <th>Tahun</th>
            <th>Tahun Aktual</th>
