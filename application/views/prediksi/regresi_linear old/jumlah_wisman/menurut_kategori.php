...
<div id="konten">
    ...
    <div class="box box-solid" id="">
        ...
        <div class="box-body mape2">
            <!-- ini tabel -->
            <table id="mape2" class="table table-bordered table-striped" style="text-align: right">
                <thead>
                    <tr>
                        <th>Periode</th>
                        <th>Tahun</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <?php $APE_jan = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_jan = round(abs((($bulan_1->jumlah) - round($prediksi_jan)) / ($bulan_1->jumlah) * 100), 2);
                                        echo $APE_jan;
                                    } else {
                                        $APE_jan = 0;
                                        echo $APE_jan;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_feb = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_feb = round(abs((($bulan_2->jumlah) - round($prediksi_feb)) / ($bulan_2->jumlah) * 100), 2);
                                        echo $APE_feb;
                                    } else {
                                        $APE_feb = 0;
                                        echo $APE_feb;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_mar = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_mar = round(abs((($bulan_3->jumlah) - round($prediksi_mar)) / ($bulan_3->jumlah) * 100), 2);
                                        echo $APE_mar;
                                    } else {
                                        $APE_mar = 0;
                                        echo $APE_mar;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_apr = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_apr = round(abs((($bulan_4->jumlah) - round($prediksi_apr)) / ($bulan_4->jumlah) * 100), 2);
                                        echo $APE_apr;
                                    } else {
                                        $APE_apr = 0;
                                        echo $APE_apr;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_mei = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_mei = round(abs((($bulan_5->jumlah) - round($prediksi_mei)) / ($bulan_5->jumlah) * 100), 2);
                                        echo $APE_mei;
                                    } else {
                                        $APE_mei = 0;
                                        echo $APE_mei;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_juni = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_juni = round(abs((($bulan_6->jumlah) - round($prediksi_juni)) / ($bulan_6->jumlah) * 100), 2);
                                        echo $APE_juni;
                                    } else {
                                        $APE_juni = 0;
                                        echo $APE_juni;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_juli = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_juli = round(abs((($bulan_7->jumlah) - round($prediksi_juli)) / ($bulan_7->jumlah) * 100), 2);
                                        echo $APE_juli;
                                    } else {
                                        $APE_juli = 0;
                                        echo $APE_juli;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_agt = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_agt = round(abs((($bulan_8->jumlah) - round($prediksi_agt)) / ($bulan_8->jumlah) * 100), 2);
                                        echo $APE_agt;
                                    } else {
                                        $APE_agt = 0;
                                        echo $APE_agt;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_sept = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_sept = round(abs((($bulan_9->jumlah) - round($prediksi_sept)) / ($bulan_9->jumlah) * 100), 2);
                                        echo $APE_sept;
                                    } else {
                                        $APE_sept = 0;
                                        echo $APE_sept;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_okt = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_okt = round(abs((($bulan_10->jumlah) - round($prediksi_okt)) / ($bulan_10->jumlah) * 100), 2);
                                        echo $APE_okt;
                                    } else {
                                        $APE_okt = 0;
                                        echo $APE_okt;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_nov = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_nov = round(abs((($bulan_11->jumlah) - round($prediksi_nov)) / ($bulan_11->jumlah) * 100), 2);
                                        echo $APE_nov;
                                    } else {
                                        $APE_nov = 0;
                                        echo $APE_nov;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $APE_des = 0;
                                    if ($bulan_1->jumlah != 0) {
                                        $APE_des = round(abs((($bulan_12->jumlah) - round($prediksi_des)) / ($bulan_12->jumlah) * 100), 2);
                                        echo $APE_des;
                                    } else {
                                        $APE_des = 0;
                                        echo $APE_des;
...
<script>
    $(document).ready(function() {
        ...
        table.buttons().container()
            .appendTo('.mape .col-sm-6:eq(0)');
    });
</script>

<script>
    $(document).ready(function() {
        var table = $('#mape2').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Tabel Jumlah Penumpang Menurut Pintu Masuk Tahun <?php echo $tahun ?> - SIPTA'
                },
