    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_RL_Restoran/cari_blok1") ?>">
                        <div class="col-md-3">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1a_2">
                <div class="box-body">
                    <div class="box-header with-border">
                        <center>
                            <p class="box-title" style="text-align: center; font-size: 13pt;">Restoran di <?php echo $nama_kab->kabupaten ?>
