    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_RL_Akomodasi/cari_blok1") ?>">
                        <div class="col-md-4">
            ...
            <div class="tab-pane active" id="tab_1a">
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di Bali
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse in">
                        <div class="box-body">
                            <div id="prediksi_ako_unit" style="height: 600px; margin: 0 auto"></div>
                        </div>
            ...
            <div class="tab-pane" id="tab_2a">
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseSiX" class="panel-collapse collapse in">
                        <div class="box-body">
                            <div id="prediksi_ako_kamar" style="height: 600px; margin: 0 auto"></div>
                        </div>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_ako_unit', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di Bali <?php echo "Tahun ".$tahun." - Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
