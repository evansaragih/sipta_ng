            ...
            <div class="tab-pane active" id="tab_1a_3">
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapse15" class="panel-collapse collapse in">
                        <div class="box-body">
                            <div id="prediksi_akomodasi_unit_3" style="height: 600px; margin: 0 auto"></div>
                        </div>
            ...
            <div class="tab-pane" id="tab_2a_3">
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseEight" class="panel-collapse collapse in">
                        <div class="box-body">
                            <div id="prediksi_akomodasi_kamar_3" style="height: 600px; margin: 0 auto"></div>
                        </div>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_3', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi di Bali <?php echo "Tahun ".$tahun." - Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
