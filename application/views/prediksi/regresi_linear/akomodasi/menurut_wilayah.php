...
<div id="konten">
            ...
            <div class="tab-pane active" id="tab_1a_2">
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse8">
                                Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di <?php echo $nama_kab->kabupaten ?>
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseSix" class="panel-collapse collapse in">
                        <div class="box-body">
                            <div id="prediksi_akomodasi_unit_2" style="height: 600px; margin: 0 auto"></div>
                        </div>
            ...
            <div class="tab-pane" id="tab_2a_2">
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseEight" class="panel-collapse collapse in">
                        <div class="box-body">
                            <div id="prediksi_akomodasi_kamar_2" style="height: 600px; margin: 0 auto"></div>
                        </div>
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_unit_2', {
            ...
            title: {
                useHTML: true,
                text: "<h4>Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di <?php echo $nama_kab->kabupaten ?><?php echo " Tahun ".$tahun." - Tahun " . ($tahun+4); ?></h4>"
            },
            yAxis: {
                allowDecimals: false,
                title: {
