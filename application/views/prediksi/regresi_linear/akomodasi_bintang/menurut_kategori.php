    ...
    <div class="kotak-sp_jlh_wisman box-default">
        <div class="box-header with-border">
            <table border="0">
                <tr>
                    <td class="col-xs-0">
                        <div class="btn-group">
                            <button type="button" class="btn btn-danger active" onclick="menurut_blok1()">Menurut Kategori Kelas Bintang</button>
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_RL_AkomodasiBintang/cari_blok1") ?>">
                        <div class="col-md-4">
                ...
                <div class="panel box box-danger">
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            ...
                            Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di Bali
                            ...
                            <table class="table table-bordered table-striped" id="blok1C" style="text-align: right">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $dp) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php $prediksi_grafik = 0;
                                                $prediksi_grafik = $f + ($e * (($rank_grafik))) ?>
                                                <?php echo number_format($prediksi_grafik) ?>
                                                <?php $y_grafik++; ?>
                                            </td>
                                            <?php $rank_grafik++ ?>
                                        </tr>
                                    ...
                                    <?php for (
                                        ...
                                        <tr>
                                            <td style="text-align: left;"><?php echo $rank_grafik + $i ?></td>
                                            <td><?php echo $tahun + ($i); ?></td>
                                            <td></td>
            ...
            <div class="tab-pane" id="tab_2a">
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse in">
                        <div class="box-body blok1E">
                            <!-- ini tabel -->
                            <table id="blok1E" class="table table-bordered table-striped" style="text-align: right">
                                <thead>
                                    <tr style="background-color:#6e0006; color:white;">
                                        <th rowspan="1" style="text-align: center; vertical-align: middle; width: 1px;">Periode</th>
                                        <th colspan="1" style="text-align: center; vertical-align: middle; width: 1px;">Tahun</th>
...
<script>
    $(document).ready(function() {
        ...
        table.buttons().container()
            .appendTo('.blok1D .col-sm-6:eq(0)');
    });
</script>

<script>
    $(document).ready(function() {
        var table = $('#blok1E').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Tabel Jumlah Penumpang Menurut Pintu Masuk Tahun <?php echo $tahun ?> - SIPTA'
                },
        ...
        table.buttons().container()
            .appendTo('.blok1E .col-sm-6:eq(0)');
    });
</script>

<script>
    $(document).ready(function() {
        var table = $('#blok1F').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Tabel Jumlah Penumpang Menurut Pintu Masuk Tahun <?php echo $tahun ?> - SIPTA'
                },
...
<script type="text/javascript">
    Highcharts.chart('prediksi_ako_unit', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di Bali <?php $tahun_data = $tahun - 1; echo "<br/> Sampai Tahun " . $tahun_data; ?></p></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<script type="text/javascript">
    Highcharts.chart('prediksi_ako_kamar', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu ?> di Bali <?php $tahun_data = $tahun - 1; echo "<br/> Sampai Tahun " . $tahun_data; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
