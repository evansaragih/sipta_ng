    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_RL_Akomodasi/cari_blok3") ?>">
                        <div class="col-md-2">
            ...
            <div class="tab-pane" id="tab_2a_3">
                <div class="panel box box-danger">
                    ...
                    <div id="collapse10" class="panel-collapse collapse">
                        <div class="box-body">
                            <div class="col-md-8 blok3D">
                                <!-- ini tabel -->
                                <table id="blok3D" class="table table-bordered table-striped" style="text-align: right">
                                    <thead>
                                        <tr style="background-color:#6e0006; color:white;">
                                            <th rowspan="1" style="text-align: center; vertical-align: middle; width: 1px;">periode (x)</th>
                                            <th colspan="1" style="text-align: center; vertical-align: middle; width: 1px;">tahun</th>
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapse11" class="panel-collapse collapse in">
                        <div class="box-body blok3E">
                            <!-- ini tabel -->
                            <table id="blok3E" class="table table-bordered table-striped" style="text-align: right">
                                <thead>
                                    <tr style="background-color:#6e0006; color:white;">
                                        <th rowspan="1" style="text-align: center; vertical-align: middle; width: 1px;">Periode</th>
                                        <th colspan="1" style="text-align: center; vertical-align: middle; width: 1px;">Tahun</th>
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseEight" class="panel-collapse collapse in">
                        ...
                        <div class="box-body blok3F">
                            <!-- ini tabel -->
                            <table class="table table-bordered table-striped" id="blok3F" style="text-align: right">
                                <thead>
                                    <tr>
                                        <th>Periode</th>
                                        <th>Tahun</th>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_3', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi di Bali <?php $tahun_data = $tahun - 1; echo " Sampai Tahun " . $tahun_data; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
