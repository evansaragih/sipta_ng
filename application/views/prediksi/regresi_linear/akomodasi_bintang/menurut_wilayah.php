...
<div id="konten">
        ...
        <div class="box-header with-border">
            <table border="0">
                <tr>
                    <td class="col-xs-0">
                        <div class="btn-group">
                            <button type="button" class="btn btn-danger" onclick="menurut_blok1()">Menurut Kategori Kelas Bintang</button>
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse8">
                                Akomodasi Hotel Bintang - <?php echo $id_pintu.' di '.$nama_kab->kabupaten ?>
                                <?php
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseEight" class="panel-collapse collapse in">
                        ...
                        <div class="box-body blok2F">
                            <!-- ini tabel -->
                            <table class="table table-bordered table-striped" id="blok2F" style="text-align: right">
                                <thead>
                                    <tr>
                                        <th>Periode</th>
                                        <th>Tahun</th>
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_unit_2', {
            ...
            title: {
                useHTML: true,
                text: "<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu.' di '.$nama_kab->kabupaten ?><?php $tahun_data = $tahun - 1; echo " Sampai Tahun " . $tahun_data; ?></h4>"
            },
            yAxis: {
                allowDecimals: false,
                title: {
