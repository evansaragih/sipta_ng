...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_RL_Bar/cari_blok2") ?>">
                        <div class="col-md-2">
    ...
    <div class="panel box box-danger">
        ...
        <div id="collapseSix" class="panel-collapse collapse in">
            <div class="box-body">
                <div id="prediksi_jwisman_blok2" style="height: 600px; margin: 0 auto"></div>
            </div>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman_blok2', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Bar di Bali <?php echo " Tahun ".$tahun." - Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
