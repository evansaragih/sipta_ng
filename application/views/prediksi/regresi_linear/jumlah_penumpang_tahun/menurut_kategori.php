    ...
    <div class="kotak-prediksi box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_RL_T_Penumpang/cari_blok1") ?>">
                        <div class="col-md-4">
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Penumpang <?php echo $nama_pintu_masuk->pintu_masuk ?> <?php $tahun_data = $tahun+4; echo " Tahun " . $tahun. " - Tahun " .$tahun_data; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
