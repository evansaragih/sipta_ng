...
<div id="konten">
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_RL_ObjekWisata/cari_blok2") ?>">
                        <div class="col-md-2">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_2a_3" data-toggle="tab">Jumlah Pengunjung</a></li>
                ...
                <div class="panel box box-danger">
                    ...
                    <div id="collapseTen" class="panel-collapse collapse in">
                        ...
                        <div class="box-body blok3C">
                            <!-- ini tabel -->
                            <table class="table table-bordered table-striped" id="blok3C" style="text-align: right">
                                <thead>
                                    <tr>
                                        <th>Periode</th>
                                        <th>Tahun</th>
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse15">
                                Jumlah Pengunjung pada Objek Wisata di Bali
                                <?php
                                echo "  Sampai Tahun " . ($tahun-1) ?>
                            </a>
                        </h4>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_3', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Objek Wisata di Bali <?php echo " Tahun ".$tahun." - Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_kamar_3', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Pengunjung pada Objek Wisata di Bali <?php echo " Tahun ".$tahun." - Tahun " . ($tahun+4); ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
