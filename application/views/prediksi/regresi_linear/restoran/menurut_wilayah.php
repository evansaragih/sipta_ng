...
<div id="konten">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_2a_2" data-toggle="tab">Pengunjung</a></li>
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse8">
                                Restoran di <?php echo $nama_kab->kabupaten ?>
                                <?php
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse11">
                                Akomodasi di <?php echo $nama_kab->kabupaten ?>
                                <?php
                                echo "  Sampai Tahun " . ($tahun - 1) ?>
                            </a>
                        </h4>
    ...
    <script type="text/javascript">
        Highcharts.chart('prediksi_akomodasi_unit_2', {
            ...
            title: {
                useHTML: true,
                text: "<h4>Restoran di <?php echo $nama_kab->kabupaten ?><?php $tahun_data = $tahun + 4;
