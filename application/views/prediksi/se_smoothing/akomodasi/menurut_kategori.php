    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_SES_Akomodasi/cari_blok1") ?>">
                        <div class="col-md-4">
...
<script type="text/javascript">
    Highcharts.chart('prediksi_ako_unit', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi <?php echo $nama_pintu_masuk->kategori ?> di Bali <?php echo " Sampai Tahun " . $tahun; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
