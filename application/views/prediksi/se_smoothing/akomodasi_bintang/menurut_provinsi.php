    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_SES_AkomodasiBintang/cari_blok3") ?>">
                        <div class="col-md-2">
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_3', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi Hotel Bintang di Bali <?php echo " Sampai Tahun " . $tahun; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
