    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_SES_AkomodasiBintang/cari_blok2") ?>">
                        <div class="col-md-3">
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_2', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Akomodasi Hotel Bintang - <?php echo $id_pintu.' di '.$nama_kab->kabupaten ." Sampai Tahun " .$tahun?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
