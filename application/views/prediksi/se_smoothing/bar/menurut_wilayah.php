    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_SES_Bar/cari_blok1") ?>">
                        <div class="col-md-3">
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Bar di <?php echo $nama_kab->kabupaten ?> <?php echo " Sampai Tahun " . $tahun; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
