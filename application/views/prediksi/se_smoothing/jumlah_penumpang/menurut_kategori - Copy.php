    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_DES_Penumpang/cari_blok2") ?>">
                        <div class="col-md-2">
...
<table id="data_prediksi_wisman_blok2" border="1" >
    <thead>
        <tr>
            <th>Tahun</th>
            <th>Tahun Aktual</th>
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman_blok2', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Jumlah Penumpang ke Bali <?php $tahun_data = $tahun - 1; echo " Sampai Tahun " . $tahun_data; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
