...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#kolom-menurut_blok1').fadeIn(900);
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_SES_Wisman/menurut_blok1", 900);
        });
        ...
        function menurut_blok2() {
            ...
            $('#kolom-menurut_blok2').fadeOut();
            myVar = setTimeout(showPage, 900);
            $('#kolom-menurut_blok2').fadeIn(900);
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>Prediksi_SES_Wisman/menurut_blok2", 5000);
        }
