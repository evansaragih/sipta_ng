    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_SES_Wisman/cari_blok1") ?>">
                        <div class="col-md-4">
            ...
            <div class="box-body">
                ...
                <?php for (
                    ...
                    <div class="box box-solid" id="tabel2_blok1" hidden>
                        <div class="box-header with-border">
                            <center>
                                <p class="box-title" style="text-align: center; font-size: 13pt;">Jumlah Wisman <?php echo $data_id_group->jenis_kebangsaan ?> ke Bali
                                    <?php $tahun_data = $tahun - 1;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_jwisman', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Prediksi Wisatawan Mancanegara <?php echo $data_id_group->jenis_kebangsaan ?> ke Bali <?php echo " Sampai Tahun " . $tahun ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
