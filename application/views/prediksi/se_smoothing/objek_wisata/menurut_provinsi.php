    ...
    <div class="kotak-sp_jlh_wisman box-default">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("Prediksi_SES_ObjekWisata/cari_blok2") ?>">
                        <div class="col-md-2">
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseNine">
                                <p class="box-title" style="text-align: center; font-size: 13pt;">Restoran di Bali
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_3', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Restoran di Bali <?php echo " Sampai Tahun " . $tahun; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
