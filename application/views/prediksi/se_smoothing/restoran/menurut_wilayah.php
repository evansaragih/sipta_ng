...
<div id="konten">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_2a_2" data-toggle="tab">Kursi</a></li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tab_2a_2">
                <div class="panel box box-danger">
                    ...
                    <div id="collapseSeven" class="panel-collapse collapse in" hidden>
                        <div class="box-body">
                            <!-- MENCARI ALFA DAN MAPE TERKECIL -->
                            <?php $MAPE_terkecil = 100;
                            $alfa_terkecil = 0;
...
<script type="text/javascript">
    Highcharts.chart('prediksi_akomodasi_unit_2', {
        ...
        title: {
            useHTML: true,
            text: "<h4>Restoran di <?php echo $nama_kab->kabupaten ?> <?php echo " Sampai Tahun " . $tahun; ?></h4>"
        },
        yAxis: {
            allowDecimals: false,
            title: {
