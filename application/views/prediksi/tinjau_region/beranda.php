...
<head>
    ...
    <style>
        .header--bg {
            /* background: url("../../dist/img/background.png") center no-repeat; */
...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <header class="header header--bg3">
                <div class="container">
                    <!-- Content Header (Page header) -->
                    <section class="content-header">
                        <h2 class="judul_1">
                            Prediksi<b style="color: orange;"> Region</b></h2>
                    </section>
                </div>
                <!-- /.container -->
            </header>
            ...
            <section class="content">
                <div class="callout callout-danger">
                    <h4>Pencarian!</h4>
                    <div class="row">
                        <form method="post" id="jpenumpang-waktu" action="<?php echo base_url('Prediksi_TinjauRegion/cari_region/') ?>">
                            <div class="col-md-4">
                                <select class="form-control select2" id="kabupaten" name="kabupaten" style="width: 100%;" data-placeholder="Pilih Salah Satu" onchange="form.submit()">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>Prediksi_TinjauRegion/menurut_blok1");
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>Prediksi_TinjauRegion/menurut_blok2");
            $("#kolom-menurut_blok3").load("<?php echo site_url(); ?>Prediksi_TinjauRegion/menurut_blok3");
            $("#kolom-menurut_blok4").load("<?php echo site_url(); ?>Prediksi_TinjauRegion/menurut_blok4");
        });
        ...
        function menurut_blok3() {
            ...
            $("#kolom-menurut_blok2").fadeOut();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok3").load("<?php echo site_url(); ?>SP_TinjauRegion/menurut_blok3");
