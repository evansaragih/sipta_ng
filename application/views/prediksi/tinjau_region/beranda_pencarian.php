...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo base_url('Prediksi_TinjauRegion/hasil_cari_blok1/' . $tahun . '/' . $kab); ?>");
            $("#kolom-menurut_blok2").load("<?php echo base_url('Prediksi_TinjauRegion/hasil_cari_blok2/' . $tahun . '/' . $kab); ?>");
            $("#kolom-menurut_blok3").load("<?php echo base_url('Prediksi_TinjauRegion/hasil_cari_blok3/' . $tahun . '/' . $kab); ?>");
            $("#kolom-menurut_blok4").load("<?php echo base_url('Prediksi_TinjauRegion/hasil_cari_blok4/' . $tahun . '/' . $kab); ?>");
        });
