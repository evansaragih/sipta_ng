<header class="header header--bg2">
    <section class="content">
        <!-- Perhitungan Prediksi Unit Restoran -->
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-12">
                ...
                <h4 style="color: white;">Jumlah Objek Wisata</h4>
            </div>
        ...
        <!-- Perhitungan Prediksi Kursi Restoran -->
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-12">
                <h4 style="color: white;">Jumlah Pengunjung</h4>
            </div>
            <div class="col-lg-3 col-xs-6">
                <!-- small box -->
                <?php $forecast = 1; ?>
