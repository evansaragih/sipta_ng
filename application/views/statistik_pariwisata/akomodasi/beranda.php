...
<body class="hold-transition skin-blue fixed sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Statistik Pariwisata
                    <small>Akomodasi di Provinsi Bali</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div id="kolom-menurut_kategori"></div>

                <div id="kolom-menurut_wilayah"></div>

                <div id="kolom-menurut_waktu">
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#kolom-menurut_kategori").load("<?php echo site_url(); ?>SP_Akomodasi/menurut_kategori");
            $('#kolom-menurut_kategori').fadeToggle();
            myVar = setTimeout(showPage, 2000);
            $('#kolom-menurut_kategori').fadeIn(1800);
        });

        function menurut_kategori() {
            $('#loader').fadeIn();
            $('#logo_loading').fadeIn();
            $('#teks_loading').fadeIn();
            $("#kolom-menurut_waktu").fadeOut();
            $("#kolom-menurut_wilayah").fadeOut();
            $("#kolom-menurut_kategori").load("<?php echo site_url(); ?>SP_Akomodasi/menurut_kategori");
            // $("#kolom-menurut_kategori").slideDown();
            $('#kolom-menurut_kategori').fadeToggle();
            myVar = setTimeout(showPage, 2000);
            $('#kolom-menurut_kategori').fadeIn(1800);
        }

        function menurut_wilayah() {
            $('#loader').fadeIn();
            $('#logo_loading').fadeIn();
            $('#teks_loading').fadeIn();
            $("#kolom-menurut_kategori").fadeOut();
            $("#kolom-menurut_waktu").fadeOut();
            $("#kolom-menurut_wilayah").load("<?php echo site_url(); ?>SP_Akomodasi/menurut_wilayah");
            $('#kolom-menurut_wilayah').fadeToggle();
            myVar = setTimeout(showPage, 2000);
            $('#kolom-menurut_wilayah').fadeIn(1800);
        }

        function menurut_waktu() {
            $('#loader').fadeIn();
            $('#logo_loading').fadeIn();
            $('#teks_loading').fadeIn();
            $("#kolom-menurut_kategori").fadeOut();
            ...
            $("#kolom-menurut_waktu").load("<?php echo site_url(); ?>SP_Akomodasi/menurut_waktu");
            // $("#kolom-menurut_waktu").slideDown();
            $('#kolom-menurut_waktu').fadeToggle();
            myVar = setTimeout(showPage, 2000);
            $('#kolom-menurut_waktu').fadeIn(1800);
        }
