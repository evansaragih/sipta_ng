...
<div class="kotak-sp_akomodasi box-default">
    <div class="box-header with-border">
        <table border="0">
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-danger active" onclick="menurut_kategori()">Menurut Kategori Akomodasi</button>
    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                <form method="post" id="akomodasi_kategori" action="<?php echo base_url("SP_Akomodasi/cari_kategori") ?>">
                    <div class="col-md-3">
...
<div class="box box-solid" id="grafik_lingkaran_c">
    <div class="box-header with-border">
        <table border="0">
            <tr>
                <td class="col-xs-0">
    ...
    <div class="box-body">
        <div id="grafik-kategori_akomodasi_2c" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
    </div>
</div>
...
<table id="data_akomodasi_kategori_pie_3" hidden>
    <thead>
        <tr>
            <th></th>
            <th>Tamu</th>
...
<script type="text/javascript">
    Highcharts.chart('grafik-kategori_akomodasi_2c', {
        data: {
            table: 'data_akomodasi_kategori_pie_3'
        },
        chart: {
            type: 'pie'
        },
        title: {
            useHTML: true,
            text: '<h4><center>Grafik Tamu Akomodasi <?php echo $nama_kabupaten->kabupaten ?> Tahun <?php echo $tahun ?></center></h4>'
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        document.getElementById("grafik_lingkaran_c").setAttribute("hidden", "hidden");
