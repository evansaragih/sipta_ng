...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#kolom-menurut_kategori").load("<?php echo base_url('SP_AkomodasiBintang/hasil_cari_kategori/' . $kab . '/' . $tahun); ?>");
        });

        function menurut_kategori() {
            $("#kolom-menurut_waktu").slideUp();
            $("#kolom-menurut_wilayah").slideUp();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_kategori").load("<?php echo site_url(); ?>SP_AkomodasiBintang/menurut_kategori");
            $("#kolom-menurut_kategori").slideDown();
        }

        function menurut_wilayah() {
            $("#kolom-menurut_kategori").slideUp();
            $("#kolom-menurut_waktu").slideUp();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_wilayah").load("<?php echo site_url(); ?>SP_AkomodasiBintang/menurut_wilayah");
            $("#kolom-menurut_wilayah").slideDown();
        }
        ...
        function menurut_waktu() {
            ...
            $("#kolom-menurut_wilayah").slideUp();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_waktu").load("<?php echo site_url(); ?>SP_AkomodasiBintang/menurut_waktu");
