    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                ...
                <form method="post" id="akomodasi_wilayah" action="<?php echo base_url("SP_AkomodasiBintang/cari_wilayah") ?>">
                    <div class="col-md-4">
...
<div class="box box-solid" id="tabel_akomodasi1">
    ...
    <div class="box-body wilayah">
        <!-- ini tabel -->
        <p class="box-title" style="text-align: center; font-size: 13pt;">Akomodasi <?php echo 'Hotel Bintang ' . $kat ?> Tahun <?php echo $tahun ?>
    ...
    <div class="box-header with-border">
        <table border="0">
            <tr>
                ...
                <td class="col-xs-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-warning active" title="Grafik Batang Horizontal" onclick="grafik_map()">Unit</button>
                        <button type="button" class="btn btn-warning" title="Grafik Map" onclick="grafik_map2()">Room</button>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="box-header with-border">
        <table border="0">
            <tr>
                ...
                <td class="col-xs-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-warning" title="Grafik Batang Horizontal" onclick="grafik_map()">Unit</button>
                        <button type="button" class="btn btn-warning active" title="Grafik Map" onclick="grafik_map2()">Room</button>
                    </div>
                </td>
            </tr>
        </table>
...
<script>
    $(document).ready(function() {
        var table = $('#wilayah').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Akomodasi <?php echo 'Hotel Bintang ' . $kat ?> Tahun <?php echo $tahun ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Akomodasi <?php echo 'Hotel Bintang ' . $kat ?> Tahun <?php echo $tahun ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Akomodasi <?php echo 'Hotel Bintang ' . $kat ?> Tahun <?php echo $tahun ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
...
<script type="text/javascript">
    Highcharts.chart('grafik-wilayah_akomodasi_1', {
        ...
        title: {
            useHTML: true,
            text: '<h4><center>Grafik Akomodasi <?php echo 'Hotel Bintang ' . $kat ?> Tahun <?php echo $tahun ?></center></h4>'
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<script type="text/javascript">
    ...
    Highcharts.mapChart('grafik-wilayah_akomodasi_4', {
        ...
        title: {
            useHTML: true,
            text: "<h4><center>Geomaps <?php echo 'Hotel Bintang ' . $kat ?> Tahun <?php echo $tahun ?> Berdasarkan Jumlah Unit</center></h4>"
        },
        legend: {
            enabled: true,
            layout: 'horizontal',
        ...
        series: [{
            name: '<?php echo 'Hotel Bintang ' . $kat ?> Tahun <?php echo $year_search ?>',
            states: {
                hover: {
                    color: '#D1351D'
                }
...
<script type="text/javascript">
    ...
    Highcharts.mapChart('grafik-wilayah_akomodasi_5', {
        ...
        title: {
            useHTML: true,
            text: "<h4><center>Geomaps Geomaps <?php echo 'Hotel Bintang ' . $kat ?> Tahun <?php echo $tahun ?> Berdasarkan Jumlah Room </center></h4>"
        },
        legend: {
            enabled: true,
            layout: 'horizontal',
