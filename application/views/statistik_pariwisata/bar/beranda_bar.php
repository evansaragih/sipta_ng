...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo base_url('SP_Bar/hasil_cari_bar/' . $id_jenis . '/' . $id_kab . '/' . $tahun); ?>");
        });
        ...
        function menurut_blok1() {
            ...
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>SP_Bar/menurut_bar");
        ...
        function menurut_blok2() {
            ...
            $("#kolom-menurut_blok3").slideUp();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>SP_Bar/menurut_wilayah");
        ...
        function menurut_blok3() {
            ...
            $("#kolom-menurut_blok2").slideUp();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok3").load("<?php echo site_url(); ?>SP_Bar/menurut_waktu");
