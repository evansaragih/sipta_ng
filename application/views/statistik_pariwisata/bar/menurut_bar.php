...
<div class="kotak-sp_bar box-default">
    <div class="box-header with-border">
        <table border="0">
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-danger active" onclick="menurut_blok1()">Menurut Bar</button>
    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                <form method="post" id="akomodasi_kategori" action="<?php echo base_url("SP_Bar/cari_bar") ?>">
                    <div class="col-md-3">
...
<div class="box box-solid" id="tabel_blok1">
    ...
    <div class="box-body blok1">
        <!-- ini tabel -->
        <p class="box-title" style="text-align: center; font-size: 13pt;">Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> di Bar area <?= $nama_kabupaten->kabupaten ?> Tahun <?php echo $tahun ?></p>
        <table id="blok1" class="table table-bordered table-striped">
            <thead>
                <tr style="background-color:#6e0006; color:white;">
                    ...
                    <th rowspan="1" style="text-align: center; vertical-align: middle;">Bar</th>
...
<script>
    $(document).ready(function() {
        var table = $('#blok1').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> di Bar area <?= $nama_kabupaten->kabupaten ?> Tahun <?php echo $tahun ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> di Bar area <?= $nama_kabupaten->kabupaten ?> Tahun <?php echo $tahun ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> di Bar area <?= $nama_kabupaten->kabupaten ?> Tahun <?php echo $tahun ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
...
<script type="text/javascript">
    Highcharts.chart('grafik-objek_wisata_blok1', {
        ...
        title: {
            useHTML: true,
            text: '<h4><center>Grafik Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> di Bar area <?= $nama_kabupaten->kabupaten ?> Tahun <?php echo $tahun ?></center></h4>'
        },
        yAxis: {
            allowDecimals: false,
            title: {
