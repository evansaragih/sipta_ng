...
<div class="kotak-sp_bar box-default">
    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                <form method="post" id="akomodasi_wilayah" action="<?php echo base_url("SP_Bar/cari_wilayah") ?>">
                    <div class="col-md-3">
...
<div class="box box-solid" id="tabel_blok2">
    ...
    <div class="box-body blok2">
        <!-- ini tabel -->
        <p class="box-title" style="text-align: center; font-size: 13pt;">Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Bar Tahun <?php echo $tahun ?>
...
<script>
    $(document).ready(function() {
        var table = $('#blok2').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Bar Tahun <?php echo $tahun ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Bar Tahun <?php echo $tahun ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Bar Tahun <?php echo $tahun ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
...
<script type="text/javascript">
    Highcharts.chart('grafik-1A_blok2-objek_wisata', {
        ...
        title: {
            useHTML: true,
            text: '<h4><center>Grafik Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Bar Tahun <?php echo $tahun ?></center></h4>'
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<script type="text/javascript">
    ...
    Highcharts.mapChart('grafik-4A_blok2-objek_wisata', {
        ...
        title: {
            useHTML: true,
            text: "<h4><center>Geomaps Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Bar Tahun <?php echo $tahun ?> Berdasarkan Jumlah Unit</center></h4>"
        },
        legend: {
            enabled: true,
            layout: 'horizontal',
        ...
        tooltip: {
            ...
            pointFormat: ' <a style="font-size:15pt"><b>{point.name}</b></a><br>' +
                '<span style="font-size:30px">{point.value} Bar</span>',
            positioner: function() {
                return {
                    x: 20,
                    y: 350
        ...
        series: [{
            name: 'Bar Tahun <?php echo $year_search ?>',
            states: {
                hover: {
                    color: '#BADA55'
                }
...
<script type="text/javascript">
    ...
    Highcharts.mapChart('grafik-4B_blok2-objek_wisata', {
        ...
        title: {
            useHTML: true,
            text: "<h4><center>Geomaps Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Bar Tahun <?php echo $tahun ?> Berdasarkan Jumlah Pengunjung</center></h4>"
        },
        legend: {
            enabled: true,
            layout: 'horizontal',
        ...
        series: [{
            name: 'Pengunjung Bar Tahun <?php echo $year_search ?>',
            states: {
                hover: {
                    color: '#BADA55'
                }
