    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                ...
                <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("SPB_JumlahPenumpang/cari_blok1") ?>">
                    <div class="col-md-3">
...
<div class="box box-solid" id="tabel_blok1">
            ...
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-danger" title="Grafik Garis" onclick="grafik_1A_blok1()"><i class="fa fa-line-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Kolom" onclick="grafik_2A_blok1()"><i class="fa fa-bar-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Garis Area" onclick="grafik_3A_blok1()"><i class="fa fa-area-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Lingkaran" onclick="grafik_4A_blok1()"><i class="fa fa-pie-chart"></i></button>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="box-body kategori">
        <!-- ini tabel -->
        <p class="box-title" style="text-align: center; font-size: 13pt;">Data Jumlah Penumpang Menurut Kategori Penumpang <?php echo $tahun ?></p>
        <table id="kategori" class="table table-bordered table-striped" style="text-align: right">
            <thead>
                <tr style="background-color:#6e0006; color:white;">
                    ...
                    <th style="text-align: center; vertical-align: middle;">Pelabuhan Lembar - Padang Bai</th>
                    <th style="text-align: center; vertical-align: middle;">Pelabuhan Ketapang - Gilimanuk</th>
                    <th style="text-align: center; vertical-align: middle;">Bandara Internasional I Gusti Ngurah Rai</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php foreach ($sum_kategori as $dp) { ?>
                        <td><?php echo number_format($dp['jumlah']) ?></td>
                    <?php } ?>
...
<div class="box box-solid" id="grafik-1A_blok1">
            ...
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-danger active" title="Grafik Garis" onclick="grafik_1A_blok1()"><i class="fa fa-line-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Kolom" onclick="grafik_2A_blok1()"><i class="fa fa-bar-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Garis Area" onclick="grafik_3A_blok1()"><i class="fa fa-area-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Lingkaran" onclick="grafik_4A_blok1()"><i class="fa fa-pie-chart"></i></button>
                    </div>
    ...
    <div class="box-body">
        <div id="grafik-1A_blok1-jpenumpang" style="min-width: 310px; height: 500px; margin: 0 auto"></div>
    </div>
</div>
...
<div class="box box-solid" id="grafik-2A_blok1">
            ...
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-danger" title="Tabel" onclick="tabel()"><i class="fa fa-table"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Garis" onclick="grafik_1A_blok1()"><i class="fa fa-line-chart"></i></button>
                        <button type="button" class="btn btn-danger active" title="Grafik Kolom" onclick="grafik_2A_blok1()"><i class="fa fa-bar-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Garis Area" onclick="grafik_3A_blok1()"><i class="fa fa-area-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Lingkaran" onclick="grafik_4A_blok1()"><i class="fa fa-pie-chart"></i></button>
                    </div>
                </td>
    ...
    <div class="box-body">
        <div id="grafik-2A_blok1-jpenumpang" style="min-width: 310px; height: 500px; margin: 0 auto"></div>
    </div>
</div>
...
<div class="box box-solid" id="grafik-3A_blok1">
            ...
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-danger" title="Grafik Garis" onclick="grafik_1A_blok1()"><i class="fa fa-line-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Kolom" onclick="grafik_2A_blok1()"><i class="fa fa-bar-chart"></i></button>
                        <button type="button" class="btn btn-danger active" title="Grafik Garis Area" onclick="grafik_3A_blok1()"><i class="fa fa-area-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Lingkaran" onclick="grafik_4A_blok1()"><i class="fa fa-pie-chart"></i></button>
                    </div>
                </td>
            </tr>
    ...
    <div class="box-body">
        <div id="grafik-3A_blok1-jpenumpang" style="min-width: 310px; height: 500px; margin: 0 auto"></div>
    </div>
</div>
...
<div class="box box-solid" id="grafik-4A_blok1">
            ...
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-danger" title="Grafik Kolom" onclick="grafik_2A_blok1()"><i class="fa fa-bar-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Garis Area" onclick="grafik_3A_blok1()"><i class="fa fa-area-chart"></i></button>
                        <button type="button" class="btn btn-danger active" title="Grafik Lingkaran" onclick="grafik_4A_blok1()"><i class="fa fa-pie-chart"></i></button>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="box-body">
        <div id="grafik-4A_blok1-jpenumpang" style="min-width: 310px; height: 500px; margin: 0 auto"></div>
    </div>
</div>

<!-- Tabel Grafik -->
<table id="grafik-data_penumpang-blok1" border="1" hidden>
    <thead>
        <tr>
            <th></th>
...
<table id="grafik-data_total_penumpang" border="1" hidden>
    <thead>
        <tr>
            <th></th>
...
<script type="text/javascript">
    Highcharts.chart('grafik-1A_blok1-jpenumpang', {
        data: {
            table: 'grafik-data_penumpang-blok1'
        },
        chart: {
            type: 'line'
        },
...
<script type="text/javascript">
    Highcharts.chart('grafik-4A_blok1-jpenumpang', {
        data: {
            table: 'grafik-data_total_penumpang'
        },
        chart: {
            type: 'pie',
            options3d: {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        document.getElementById("grafik-4A_blok1").setAttribute("hidden", "hidden");
    });
