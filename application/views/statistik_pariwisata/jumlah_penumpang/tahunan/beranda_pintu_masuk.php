...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#kolom-menurut_blok2").load("<?php echo base_url('SPT_JumlahPenumpang/hasil_cari_blok2/' . $id_pintu_masuk . '/' . $tahun); ?>");
        });

        function menurut_blok1() {
            $("#kolom-menurut_blok2").fadeOut();
            $("#kolom-menurut_blok3").fadeOut();
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>SPT_JumlahPenumpang/menurut_blok1");
        ...
        function menurut_blok2() {
            ...
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>SPT_JumlahPenumpang/menurut_blok2");
        ...
        function menurut_blok3() {
            $("#kolom-menurut_blok1").fadeOut();
            $("#kolom-menurut_blok2").fadeOut();
            $("#kolom-menurut_blok3").load("<?php echo site_url(); ?>SPT_JumlahPenumpang/menurut_blok3");
