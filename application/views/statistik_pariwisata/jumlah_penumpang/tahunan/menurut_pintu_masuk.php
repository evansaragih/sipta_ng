            ...
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-danger active" onclick="menurut_blok2()">Menurut Pintu Masuk</button>
    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                ...
                <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("SPT_JumlahPenumpang/cari_blok2") ?>">
                    <div class="col-md-3">
        ...
        <table id="pintu" class="table table-bordered table-striped" style="text-align: right">
            <thead>
                <tr style="background-color:#6e0006; color:white;">
                    ...
                    <th style="text-align: center; vertical-align: middle; width: 10px;">Jumlah</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left;"><?= ($tahun - 1) ?></td>
                    <?php $total2 = 0; ?>
                ...
                <tr>
                    ...
                    <td style="text-align: left;"><?= ($tahun - 2) ?></td>
                    <?php $total3 = 0; ?>
                ...
                <tr>
                    ...
                    <td style="text-align: left;"><?= ($tahun - 3) ?></td>
                    <?php $total4 = 0; ?>
                ...
                <tr>
                    ...
                    <td style="text-align: left;"><?= ($tahun - 4) ?></td>
                    <?php $total5 = 0; ?>
...
<!-- Tabel Grafik -->
<table id="grafik-data_penumpang-blok2" border="1" hidden>
    <thead>
        <tr>
            <th>Tahun</th>
            <th>Internasional</th>
