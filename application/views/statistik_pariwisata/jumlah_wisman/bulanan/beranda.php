...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>SPB_JumlahWisman/menurut_blok1");
        ...
        function menurut_blok1() {
            ...
            $('#kolom-menurut_blok1').fadeToggle(100);
            myVar = setTimeout(showPage, 100);
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>SPB_JumlahWisman/menurut_blok1");
            $('#kolom-menurut_blok1').fadeIn()
        }
        ...
        function menurut_blok1b() {
            ...
            $("#kolom-menurut_blok1b").load("<?php echo site_url(); ?>SPB_JumlahWisman/menurut_blok1b");
        ...
        function menurut_blok2() {
            ...
            $("#kolom-menurut_blok4").fadeOut(10);
            $("#kolom-menurut_blok5").fadeOut(10);
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>SPB_JumlahWisman/menurut_blok2");
            $('#kolom-menurut_blok2').fadeToggle(1000);
            myVar = setTimeout(showPage, 1000);
            $('#kolom-menurut_blok2').fadeIn(5000);
        }
        ...
        function menurut_blok3() {
            ...
            $('#kolom-menurut_blok3').fadeToggle(1000);
            myVar = setTimeout(showPage, 1000);
            $('#kolom-menurut_blok3').fadeIn(5000);
        }
        ...
        function menurut_blok4() {
            ...
            $('#kolom-menurut_blok4').fadeToggle(1000);
            myVar = setTimeout(showPage, 1000);
            $('#kolom-menurut_blok4').fadeIn(5000);
        }
        ...
        function menurut_blok5() {
            ...
            $('#kolom-menurut_blok5').fadeToggle(1000);
            myVar = setTimeout(showPage, 1000);
            $('#kolom-menurut_blok5').fadeIn(5000);
        }
    </script>
