...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#kolom-menurut_blok1").load("<?php echo base_url('SPB_JumlahWisman/hasil_cari_blok1b/' . $tahun . '/' . $bulan); ?>");
        ...
        function menurut_blok1() {
            ...
            myVar = setTimeout(showPage, 100);
            $("#kolom-menurut_blok1").load("<?php echo base_url('SPB_JumlahWisman/hasil_cari_blok1/' . $tahun); ?>");
            $('#kolom-menurut_blok1').fadeIn(100)
        }
        ...
        function menurut_blok1b() {
            ...
            $("#kolom-menurut_blok1b").load("<?php echo base_url('SPB_JumlahWisman/hasil_cari_blok1b/' . $tahun . '/' . '1'); ?>");
