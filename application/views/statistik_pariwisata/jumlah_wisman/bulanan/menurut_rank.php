...
<div id="konten">
        ...
        <div class="box-body">
            <div class="callout callout-picture">
                <div class="row">
                    <div class="col-md-3">
                        <div class="btn-group">
                            <a type="button" class="btn btn-success active" href="<?php echo base_url('SPB_JumlahWisman') ?>">Bulanan</a>
                            <a type="button" class="btn btn-success" href="<?php echo base_url('SPT_JumlahWisman') ?>">Tahunan</a>
                        </div>
                    </div>
                    <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("SPB_JumlahWisman/cari_blok5") ?>">
                        <div class="col-md-2">
                            <select class="form-control select2" id="id_bulan" name="id_bulan" style="width: 100%;" data-placeholder="Pilih Salah Satu" onchange="form.submit()">
                                <?php foreach ($data_bulan_blok5 as $b) { ?>
    ...
    <div class="box box-solid" id="tabel_blok5">
        <div class="box-header with-border">
            <center>
                <p class="box-title" style="text-align: center; font-size: 13pt;">Kedatangan Wisatawan Mancanegara Menurut Ranking <br /><?php echo "Bulan " . $data_id_bulan->bulan . " Tahun " . $tahun ?></p>
            </center>
        </div>
...
<script>
    $(document).ready(function() {
        var table = $('#blok5').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Kedatangan Wisatawan Mancanegara Menurut Ranking <?php echo "Bulan " . $data_id_bulan->bulan . " Tahun " . $tahun ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Kedatangan Wisatawan Mancanegara Menurut Ranking <?php echo "Bulan " . $data_id_bulan->bulan . " Tahun " . $tahun ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Kedatangan Wisatawan Mancanegara Menurut Ranking <br/><?php echo "Bulan " . $data_id_bulan->bulan . " Tahun " . $tahun ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
