    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                ...
                <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("SPB_JumlahWisman/cari_blok4") ?>">
                    <div class="col-md-4">
...
<div class="box box-solid" id="tabel_blok4">
    ...
    <div class="box-body blok4">
        <!-- ini tabel -->
        <p class="box-title" style="text-align: center; font-size: 13pt;">Data Kedatangan Wisatawan <?php echo $data_id_kebangsaan->kebangsaan ?> Tahun <?php echo $tahun ?></p>
        <table id="blok4" class="table table-bordered table-striped" style="text-align: right">
            <thead>
                <tr style="background-color:#6e0006; color:white;">
                    ...
                    <th rowspan="1" style="text-align: center; vertical-align: middle; width: 600px;">Bulan</th>
            ...
            <tbody>
                ...
                <?php foreach ($data_jwisman as $dp) { ?>
                    <tr><?php $no++;
                        ...
                        <td style="text-align: center"><?php echo $dp['bulan']; ?></td>
...
<script>
    $(document).ready(function() {
        var table = $('#blok4').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Kedatangan Wisatawan <?php echo $data_id_kebangsaan->kebangsaan ?> Tahun <?php echo $tahun ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Kedatangan Wisatawan <?php echo $data_id_kebangsaan->kebangsaan ?> Tahun <?php echo $tahun ?> - SIPTA'
...
<script type="text/javascript">
    Highcharts.chart('grafik-1A_blok4-jpenumpang', {
        ...
        title: {
            useHTML: true,
            text: '<h4><center>Grafik Kedatangan Wisatawan <?php echo $data_id_kebangsaan->kebangsaan ?> Tahun <?php echo $tahun ?></center></h4>'
        },
        plotOptions: {
            column: {
                dataLabels: {
        ...
        tooltip: {
            formatter: function() {
                return '<b>' + this.series.name + ' ' + this.point.x + '</b><br/>' +
                    this.point.y + ' orang';
            }
        }
    });
