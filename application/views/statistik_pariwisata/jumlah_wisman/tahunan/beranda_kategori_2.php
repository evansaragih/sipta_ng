...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo base_url('SPT_JumlahWisman/hasil_cari_blok1b/' . $tahun); ?>");
        ...
        function menurut_blok1() {
            ...
            $("#kolom-menurut_blok1").load("<?php echo base_url('SPT_JumlahWisman/hasil_cari_blok1/' . $tahun); ?>");
            myVar = setTimeout(showPage, 5000);
        ...
        function menurut_blok1b() {
            ...
            myVar = setTimeout(showPage, 5000);
            $("#kolom-menurut_blok1b").load("<?php echo base_url('SPT_JumlahWisman/hasil_cari_blok1b/' . $tahun); ?>");
