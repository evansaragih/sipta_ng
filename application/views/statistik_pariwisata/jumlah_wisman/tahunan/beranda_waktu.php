...
<body class="hold-transition skin-blue fixed sidebar-mini" onload="MyLoading()">
    <!-- Site wrapper -->
            ...
            <section class="content">
                ...
                <div id="teks_loading">
                    <center>
                        ...
                        <h4 id="pesan_1">Memuat Data ...</h4>
                        <h4 id="pesan_2" hidden>Memuat Data <br />Memakan Waktu Yang Lama ...</h4>
                    </center>
                </div>
                <!-- akhir Logo Loading -->
                <div id="kolom-menurut_blok1"></div>

                <div id="kolom-menurut_blok1b"></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#kolom-menurut_blok4").load("<?php echo base_url('SPT_JumlahWisman/hasil_cari_blok4/' . $id_nationality); ?>");
        ...
        function menurut_blok1() {
            ...
            $('#logo_loading').fadeIn();
            $('#teks_loading').fadeIn();
            $("#kolom-menurut_blok1b").fadeOut(10);
            $("#kolom-menurut_blok2").fadeOut(10);
            $("#kolom-menurut_blok3").fadeOut(10);
            $("#kolom-menurut_blok4").fadeOut(10);
            $("#kolom-menurut_blok5").fadeOut(10);
            $('#kolom-menurut_blok1').fadeToggle();
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>SPT_JumlahWisman/menurut_blok1");
            myVar = setTimeout(showPage, 5000);
            $('#kolom-menurut_blok1').fadeIn(5000);
            // $('#konten').fadeIn(100);
        }

        function menurut_blok1b() {
            $('#loader').fadeIn();
            $('#logo_loading').fadeIn();
            $('#teks_loading').fadeIn();
            $('#pesan_1').attr("hidden", true);
            $('#pesan_2').removeAttr('hidden');
            $("#kolom-menurut_blok2").fadeOut(10);
            $("#kolom-menurut_blok3").fadeOut(10);
            $("#kolom-menurut_blok4").fadeOut(10);
            $("#kolom-menurut_blok5").fadeOut(10);
            $("#kolom-menurut_blok1").fadeOut(10);
            $('#kolom-menurut_blok1b').fadeToggle(5000);
            myVar = setTimeout(showPage, 5000);
            $("#kolom-menurut_blok1b").load("<?php echo site_url(); ?>SPT_JumlahWisman/menurut_blok1b");
            $('#kolom-menurut_blok1b').fadeIn(1000);
        }
        ...
        function showPage() {
            ...
            $('#pesan_1').attr("hidden", false);
            $('#pesan_2').attr("hidden", true);
        }
        ...
        function menurut_blok2() {
            ...
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>SPT_JumlahWisman/menurut_blok2");
        ...
        function menurut_blok3() {
            ...
            $("#kolom-menurut_blok5").fadeOut();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok3").load("<?php echo site_url(); ?>SPT_JumlahWisman/menurut_blok3");
        ...
        function menurut_blok4() {
            ...
            $("#kolom-menurut_blok3").fadeOut();
            $("#kolom-menurut_blok5").fadeOut();
            $("#kolom-menurut_blok4").load("<?php echo site_url(); ?>SPT_JumlahWisman/menurut_blok4");
        ...
        function menurut_blok5() {
            ...
            $("#kolom-menurut_blok3").fadeOut();
            $("#kolom-menurut_blok4").fadeOut();
            $("#kolom-menurut_blok5").load("<?php echo site_url(); ?>SPT_JumlahWisman/menurut_blok5");
