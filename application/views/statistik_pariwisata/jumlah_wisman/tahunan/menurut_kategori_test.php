            ...
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-danger" title="Grafik Map" onclick="grafik_3A_blok2()"><i class="fa fa-map"></i></button>
                    </div>
                </td>
            </tr>
        </table>
...
<div class="box box-solid" id="grafik-3A_blok2">
            ...
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-danger" title="Grafik Batang Vertikal" onclick="grafik_1A_blok2()"><i class="fa fa-bar-chart"></i></button>
                        <button type="button" class="btn btn-danger" title="Grafik Garis" onclick="grafik_2A_blok2()"><i class="fa fa-pie-chart"></i></button>
                        <button type="button" class="btn btn-danger active" title="Grafik Map" onclick="grafik_3A_blok2()"><i class="fa fa-map"></i></button>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="box-body">
        <div id="tahun_1C">
            <div class="btn-group">
                <button type="button" class="btn btn-warning active" title="<?php echo $tahun ?>" onclick="tahun_1C()"><?php echo $tahun ?></button>
                <button type="button" class="btn btn-warning" title="<?php echo $tahun_vs ?>" onclick="tahun_2C()"><?php echo $tahun_vs ?></button>
            </div>
            <div id="grafik-3A_blok2-jpenumpang" style="min-width: 350px; height: 600px; margin: 0 auto"></div>
        </div>
        <div id="tahun_2C" hidden>
            <div class="btn-group">
                <button type="button" class="btn btn-warning" title="<?php echo $tahun ?>" onclick="tahun_1C()"><?php echo $tahun ?></button>
                <button type="button" class="btn btn-warning active" title="<?php echo $tahun_vs ?>" onclick="tahun_2C()"><?php echo $tahun_vs ?></button>
            </div>
            <div id="grafik-3B_blok2-jpenumpang" style="min-width: 350px; height: 600px; margin: 0 auto"></div>
        </div>
    </div>
</div>
    ...
    <thead>
        <tr>
            ...
            <?php foreach ($grup_kebangsaan as $a) { ?>
                <th><?php echo $a['jenis_kebangsaan'] ?></th>
            <?php } ?>
        </tr>
    </thead>
    <tbody>
...
<script type="text/javascript">
    // Initiate the chart
    Highcharts.mapChart('grafik-3A_blok2-jpenumpang', {
        chart: {
            type: "map"
        },
        title: {
        ...
        colorAxis: {
            min: "1",
            max: "<?php echo max($bulan_1->jumlah, $bulan_2->jumlah, $bulan_3->jumlah, $bulan_4->jumlah, $bulan_5->jumlah, $bulan_6->jumlah) ?>",
            type: 'logarithmic',
            minColor: '#B9D5EA',
            maxColor: '#08306D',
            stops: [
        ...
        series: [{
            ...
            data: [{
                    "name": "<?php echo $bulan_1->kebangsaan ?>",
                    "value": "<?php echo $bulan_1->jumlah ?>",
                    "path": "<?php echo $bulan_1->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_2->kebangsaan ?>",
                    "value": "<?php echo $bulan_2->jumlah ?>",
                    "path": "<?php echo $bulan_2->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_3->kebangsaan ?>",
                    "value": "<?php echo $bulan_3->jumlah ?>",
                    "path": "<?php echo $bulan_3->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_4->kebangsaan ?>",
                    "value": "<?php echo $bulan_4->jumlah ?>",
                    "path": "<?php echo $bulan_4->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_5->kebangsaan ?>",
                    "value": "<?php echo $bulan_5->jumlah ?>",
                    "path": "<?php echo $bulan_5->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_6->kebangsaan ?>",
                    "value": "<?php echo $bulan_6->jumlah ?>",
                    "path": "<?php echo $bulan_6->path_map ?>"
                }
            ]
        }]
    });
...
<script type="text/javascript">
    // Initiate the chart
    Highcharts.mapChart('grafik-3B_blok2-jpenumpang', {
        chart: {
            type: "map"
        },
        title: {
            useHTML: true,
            text: "<h4><center>Geomaps Kedatangan Wisatawan Mancanegara Berdasarkan Kebangsaan </br>Bulan Januari Tahun <?php echo $tahun_vs; ?> </center></h4>"
        },
        legend: {
            enabled: true,
            layout: 'horizontal',
        ...
        colorAxis: {
            min: "1",
            max: "<?php echo max($bulan_1_tahunvs->jumlah, $bulan_2_tahunvs->jumlah, $bulan_3_tahunvs->jumlah, $bulan_4_tahunvs->jumlah, $bulan_5_tahunvs->jumlah, $bulan_6_tahunvs->jumlah) ?>",
            type: 'logarithmic',
            minColor: '#B9D5EA',
            maxColor: '#08306D',
            stops: [
        ...
        series: [{
            ...
            data: [{
                    "name": "<?php echo $bulan_1_tahunvs->kebangsaan ?>",
                    "value": "<?php echo $bulan_1_tahunvs->jumlah ?>",
                    "path": "<?php echo $bulan_1_tahunvs->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_2_tahunvs->kebangsaan ?>",
                    "value": "<?php echo $bulan_2_tahunvs->jumlah ?>",
                    "path": "<?php echo $bulan_2_tahunvs->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_3_tahunvs->kebangsaan ?>",
                    "value": "<?php echo $bulan_3_tahunvs->jumlah ?>",
                    "path": "<?php echo $bulan_3_tahunvs->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_4_tahunvs->kebangsaan ?>",
                    "value": "<?php echo $bulan_4_tahunvs->jumlah ?>",
                    "path": "<?php echo $bulan_4_tahunvs->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_5_tahunvs->kebangsaan ?>",
                    "value": "<?php echo $bulan_5_tahunvs->jumlah ?>",
                    "path": "<?php echo $bulan_5_tahunvs->path_map ?>"
                },
                {
                    "name": "<?php echo $bulan_6_tahunvs->kebangsaan ?>",
                    "value": "<?php echo $bulan_6_tahunvs->jumlah ?>",
                    "path": "<?php echo $bulan_6_tahunvs->path_map ?>"
                }
            ]
        }]
    });
