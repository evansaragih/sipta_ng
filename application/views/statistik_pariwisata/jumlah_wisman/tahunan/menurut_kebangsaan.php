    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                ...
                <form method="post" id="jpenumpang_pintu-masuk" action="<?php echo base_url("SPT_JumlahWisman/cari_blok3") ?>">
                    <div class="col-md-4">
...
<div class="box box-solid" id="tabel_blok3">
    ...
    <div class="box-body blok3">
        <!-- ini tabel -->
        <p class="box-title" style="text-align: center; font-size: 13pt;">Data Perbandingan Wisatawan Mancanegara Kategori<br /> <?php echo $data_id_group->grup . ' Tahun ' . $tahun ?></p>
...
<script>
    $(document).ready(function() {
        var table = $('#blok3').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Data Perbandingan Wisatawan Mancanegara Kategori <?php echo $data_id_group->grup . ' Tahun ' . $tahun ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Data Perbandingan Wisatawan Mancanegara Kategori <?php echo $data_id_group->grup . ' Tahun ' . $tahun ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Data Perbandingan Wisatawan Mancanegara Kategori<br /> <?php echo $data_id_group->grup . ' Tahun ' . $tahun ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
