...
<body class="hold-transition skin-blue fixed sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Statistik Pariwisata
                    <small>Objek Wisata di Provinsi Bali</small>
                </h1>
                <ol class="breadcrumb">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo base_url('SP_ObjekWisata/hasil_cari_objek_wisata/' . $id_jenis . '/' . $id_kab . '/' . $tahun); ?>");
        });

        function menurut_blok1() {
            $("#kolom-menurut_blok2").slideUp();
            $("#kolom-menurut_blok3").slideUp();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>SP_ObjekWisata/menurut_objek_wisata");
            $("#kolom-menurut_blok1").slideDown();
        }

        function menurut_blok2() {
            $("#kolom-menurut_blok1").slideUp();
            $("#kolom-menurut_blok3").slideUp();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok2").load("<?php echo site_url(); ?>SP_ObjekWisata/menurut_wilayah");
        ...
        function menurut_blok3() {
            ...
            $("#kolom-menurut_blok2").slideUp();
            //document.getElementById("kolom-menurut_kategori").setAttribute("hidden", "hidden");
            $("#kolom-menurut_blok3").load("<?php echo site_url(); ?>SP_ObjekWisata/menurut_waktu");
