...
<div class="kotak-sp_objek_wisata box-default">
    <div class="box-header with-border">
        <table border="0">
            <tr>
                <td class="col-xs-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-danger" onclick="menurut_blok1()">Menurut Objek Wisata</button>
    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                <form method="post" id="akomodasi_wilayah" action="<?php echo base_url("SP_ObjekWisata/cari_wilayah") ?>">
                    <div class="col-md-3">
...
<div class="box box-solid" id="tabel_blok2">
    ...
    <div class="box-body blok2">
        <!-- ini tabel -->
        <p class="box-title" style="text-align: center; font-size: 13pt;">Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Objek Wisata Tahun <?php echo $tahun ?>
            <table id="blok2" class="table table-bordered table-striped">
                <thead>
                    <tr style="background-color:#6e0006; color:white;">
                        ...
                        <th colspan="2" style="text-align: center;">Objek Wisata</th>
                    </tr>
                    <tr style="background-color:#6e0006; color:white;">
...
<script>
    $(document).ready(function() {
        var table = $('#blok2').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Objek Wisata Tahun <?php echo $tahun ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Objek Wisata Tahun <?php echo $tahun ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Objek Wisata Tahun <?php echo $tahun ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
...
<script type="text/javascript">
    Highcharts.chart('grafik-1A_blok2-objek_wisata', {
        ...
        title: {
            useHTML: true,
            text: '<h4><center>Grafik Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Objek Wisata Tahun <?php echo $tahun ?></center></h4>'
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<script type="text/javascript">
    ...
    Highcharts.mapChart('grafik-4A_blok2-objek_wisata', {
        ...
        title: {
            useHTML: true,
            text: "<h4><center>Geomaps Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Objek Wisata Tahun <?php echo $tahun ?> Berdasarkan Jumlah Unit</center></h4>"
        },
        legend: {
            enabled: true,
            layout: 'horizontal',
        ...
        tooltip: {
            ...
            pointFormat: ' <a style="font-size:15pt"><b>{point.name}</b></a><br>' +
                '<span style="font-size:30px">{point.value} Objek Wisata</span>',
            positioner: function() {
                return {
                    x: 20,
                    y: 350
        ...
        series: [{
            name: 'Objek Wisata Tahun <?php echo $year_search ?>',
            states: {
                hover: {
                    color: '#BADA55'
                }
...
<script type="text/javascript">
    ...
    Highcharts.mapChart('grafik-4B_blok2-objek_wisata', {
        ...
        title: {
            useHTML: true,
            text: "<h4><center>Geomaps Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> Objek Wisata Tahun <?php echo $tahun ?> Berdasarkan Jumlah Pengunjung</center></h4>"
        },
        legend: {
            enabled: true,
            layout: 'horizontal',
        ...
        series: [{
            name: 'Pengunjung Objek Wisata Tahun <?php echo $year_search ?>',
            states: {
                hover: {
                    color: '#BADA55'
                }
