...
<div class="kotak-sp_restoran box-default">
    ...
    <div class="box-body">
        <div class="callout callout-picture">
            <div class="row">
                <form method="post" id="akomodasi_kategori" action="<?php echo base_url("SP_Restoran/cari_waktu") ?>">
                    <div class="col-md-3">
...
<div class="box box-solid" id="tabel_blok3">
    ...
    <div class="box-body blok3">
        <!-- ini tabel -->
        <p class="box-title" style="text-align: center; font-size: 13pt;">Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> pada Restoran area <?= $nama_kabupaten->kabupaten ?></p>
...
<script>
    $(document).ready(function() {
        var table = $('#blok3').DataTable({
            'buttons': [{
                    extend: 'csvHtml5',
                    title: 'Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> pada Restoran area <?= $nama_kabupaten->kabupaten ?> - SIPTA'
                },
                {
                    extend: 'excelHtml5',
                    title: 'Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> pada Restoran area <?= $nama_kabupaten->kabupaten ?> - SIPTA'
                ...
                {
                    extend: 'print',
                    title: '<h4>Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> pada Restoran area <?= $nama_kabupaten->kabupaten ?> - SIPTA</h4>'
                }
                // {
                //   extend: 'colvis',
...
<script type="text/javascript">
    Highcharts.chart('grafik-1A_blok3-objek_wisata', {
        ...
        title: {
            useHTML: true,
            text: '<h4><center>Grafik Pengunjung <?= $jenis_wisatawan->jenis_wisatawan ?> pada Restoran area <?= $nama_kabupaten->kabupaten ?></center></h4>'
        },
        yAxis: {
            allowDecimals: false,
            title: {
