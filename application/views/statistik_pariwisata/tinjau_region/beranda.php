...
<body class="hold-transition skin-blue fixed sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <header class="header header--bg3">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h2 class="judul_1">
                            Tinjau<b style="color: orange;"> Region</b></h2>
                    </section>
                </div>
                <!-- /.container -->
            </header>
            ...
            <section class="content">
                <div class="callout callout-danger">
                    <h4>Pencarian!</h4>
                    <div class="row">
                        <form method="post" id="jpenumpang-waktu" action="<?php echo base_url('SP_TinjauRegion/cari_region/') ?>">
                            <div class="col-md-4">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#kolom-menurut_blok1").load("<?php echo site_url(); ?>SP_TinjauRegion/menurut_blok1");
        });
