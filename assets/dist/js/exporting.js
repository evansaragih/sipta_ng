...
(function (g) {
	"object" === typeof module && module.exports
		...
		? define("highcharts/modules/exporting", ["highcharts"], function (n) {
				g(n);
				g.Highcharts = n;
				return g;
		  })
	...
	n(
		g,
		"modules/full-screen.src.js",
		[g["parts/Globals.js"], g["parts/Utilities.js"]],
		function (e, f) {
			var g = f.addEvent;
			f = e.Chart;
			var l = (function () {
				function e(k) {
					...
					k = k.renderTo;
					this.browserProps ||
						("function" === typeof k.requestFullscreen
							? (this.browserProps = {
				...
				e.prototype.close = function () {
					...
					if (
						this.isOpen &&
						this.browserProps &&
						k.container.ownerDocument instanceof Document
					)
						k.container.ownerDocument[this.browserProps.exitFullscreen]();
				...
				e.prototype.open = function () {
					var k = this,
						e = k.chart;
					if (k.browserProps) {
						k.unbindFullscreenEvent = g(
							e.container.ownerDocument,
							k.browserProps.fullscreenChange,
							function () {
								k.isOpen
									? ((k.isOpen = !1), k.close())
									: ((k.isOpen = !0), k.setButtonText());
							}
						);
				...
				e.prototype.setButtonText = function () {
					var e,
						...
						q =
							null === (e = null === l || void 0 === l ? void 0 : l.buttons) ||
							void 0 === e
								? void 0
								: e.contextButton.menuItems;
					e = f.options.lang;
					(null === l || void 0 === l ? 0 : l.menuItemDefinitions) &&
						(null === e || void 0 === e ? 0 : e.exitFullscreen) &&
						e.viewFullscreen &&
						q &&
						g &&
						g.length &&
						(g[q.indexOf("viewFullscreen")].innerHTML = this.isOpen
							? e.exitFullscreen
							: l.menuItemDefinitions.viewFullscreen.text || e.viewFullscreen);
				};
	...
	n(g, "mixins/navigation.js", [], function () {
		return {
			...
			addUpdate: function (e, f) {
				...
				f.navigation.updates.push({ update: e, context: f });
			},
		};
	});
	n(
		...
		[g["parts/Globals.js"], g["parts/Utilities.js"], g["mixins/navigation.js"]],
		function (e, f, g) {
			var l = f.addEvent,
				q = f.css,
				k = f.createElement,
			...
			e.post = function (a, b, c) {
				var d = k(
					"form",
					r({ method: "post", action: a, enctype: "multipart/form-data" }, c),
					{ display: "none" },
					x.body
				);
				E(b, function (a, b) {
					k("input", { type: "hidden", name: b, value: a }, null, d);
				});
				d.submit();
				n(d);
			};
			e.isSafari &&
				e.win.matchMedia("print").addListener(function (a) {
					e.printingChart &&
						(a.matches
							? e.printingChart.beforePrint()
							: e.printingChart.afterPrint());
				});
			w(B.prototype, {
				...
				contextMenu: function (a, b, c, d, e, g, u) {
					...
					if (!m) {
						...
						m.hideMenu = function () {
							...
							u && u.setState(0);
							h.openMenu = !1;
							q(h.renderTo, { overflow: "hidden" });
							f.clearTimeout(m.hideTimer);
							A(h, "exportMenuHidden");
						};
						h.exportEvents.push(
							l(m, "mouseleave", function () {
									...
									(b = k(
										...
										h.styledMode ||
											((b.onmouseover = function () {
												q(this, D.menuItemHoverStyle);
											}),
											(b.onmouseout = function () {
												q(this, D.menuItemStyle);
											}),
											q(b, w({ cursor: "pointer" }, D.menuItemStyle)));
					...
					b = { display: "block" };
					c + h.exportMenuWidth > r
						? (b.right = r - c - e - C + "px")
						: (b.left = c - C + "px");
					d + g + h.exportMenuHeight > z &&
					"top" !== u.alignOptions.verticalAlign
						? (b.bottom = z - d - C + "px")
						: (b.top = d + g - C + "px");
					q(m, b);
					q(h.renderTo, { overflow: "" });
					h.openMenu = !0;
					A(h, "exportMenuShown");
				},
				addButton: function (a) {
					...
					if (!1 !== d.enabled) {
						...
						d.text && d.symbol
							...
							: d.text ||
							  w(h, { width: d.width, height: d.height, padding: 0 });
						b.styledMode ||
							((h["stroke-linecap"] = "round"),
							(h.fill = t(h.fill, "#ffffff")),
							(h.stroke = t(h.stroke, "none")));
						var p = c
							.button(d.text, 0, 0, z, h, l, k)
						...
						p.add(b.exportingGroup).align(
							w(d, { width: p.width, x: t(d.x, b.buttonOffset) }),
							!0,
							"spacingBox"
						);
						b.buttonOffset +=
							(p.width + d.buttonSpacing) * ("right" === d.align ? -1 : 1);
			...
			B.prototype.inlineStyles = function () {
				...
				function b(c) {
					function p(b, f) {
						...
						for (t = e.length; t-- && !n; )
							n = e[t].test(f) || "function" === typeof b;
						n ||
							(w[f] === b && "svg" !== c.nodeName) ||
							h[c.nodeName][f] === b ||
							(-1 !== d.indexOf(f)
					...
					if (1 === c.nodeType && -1 === f.indexOf(c.nodeName)) {
						...
						if (O || N) for (var x in u) p(u[x], x);
						else E(u, p);
						m &&
							((u = c.getAttribute("style")),
							c.setAttribute("style", (u ? u + ";" : "") + m));
				...
				q(c, { width: "1px", height: "1px", visibility: "hidden" });
